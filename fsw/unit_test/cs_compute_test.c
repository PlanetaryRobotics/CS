...
int32 CS_COMPUTE_TEST_CFE_TBL_GetAddressHook(void **TblPtr,
                                             CFE_TBL_Handle_t TblHandle) {
    /* This function exists so that one return code can be set for the 1st run
     * and a different for the 2nd run */

    return CFE_TBL_ERR_UNREGISTERED;
}

int32 CS_COMPUTE_TEST_CFE_TBL_GetInfoHook1(CFE_TBL_Info_t *TblInfoPtr,
                                           const char *TblName) {
    TblInfoPtr->Size = 5;
...
int32 CS_COMPUTE_TEST_CFE_TBL_GetInfoHook2(CFE_TBL_Info_t *TblInfoPtr,
                                           const char *TblName) {
    TblInfoPtr->Size = 5;
...
int32 CS_COMPUTE_TEST_CFE_TBL_ShareHook(CFE_TBL_Handle_t *TblHandlePtr,
                                        const char *TblName) {
    *TblHandlePtr = 99;
...
int32 CS_COMPUTE_TEST_CFE_ES_GetAppInfoHook1(CFE_ES_AppInfo_t *AppInfo,
                                             uint32 AppId) {
    AppInfo->CodeSize          = 5;
...
int32 CS_COMPUTE_TEST_CFE_ES_GetAppInfoHook2(CFE_ES_AppInfo_t *AppInfo,
                                             uint32 AppId) {
...
void CS_ComputeEepromMemory_Test_Nominal(void) {
    ...
    Result =
        CS_ComputeEepromMemory(&ResultsEntry, &ComputedCSValue, &DoneWithEntry);
...
void CS_ComputeEepromMemory_Test_FirstTimeThrough(void) {
    ...
    /* ComputedCSValue and ResultsEntry.ComparisonValue will be set to value
    ...
    UtAssert_True(ResultsEntry.ComputedYet == TRUE,
                  "ResultsEntry.ComputedYet == TRUE");
    UtAssert_True(ResultsEntry.ComparisonValue == 1,
                  "ResultsEntry.ComparisonValue == 1");
    UtAssert_True(ComputedCSValue == 1, "ComputedCSValue == 1");
    UtAssert_True(ResultsEntry.ByteOffset == 0, "ResultsEntry.ByteOffset == 0");
    UtAssert_True(ResultsEntry.TempChecksumValue == 0,
...
void CS_ComputeEepromMemory_Test_NotFinished(void) {
    ...
    /* ComputedCSValue and ResultsEntry.TempChecksumValue will be set to value
     * returned by this function */
    Ut_CFE_ES_SetReturnCode(UT_CFE_ES_CALCULATECRC_INDEX, 1, 1);
    ...
    UtAssert_True(ResultsEntry.TempChecksumValue == 1,
                  "ResultsEntry.TempChecksumValue == 1");
...
void CS_ComputeTables_Test_TableNeverLoaded(void) {
    ...
    /* Set to satisfy first instance of condition "ResultGetAddress ==
     * CFE_TBL_ERR_NEVER_LOADED" */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX,
                             CFE_TBL_ERR_NEVER_LOADED, 1);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_COMPUTE_TABLES_ERR_EID, CFE_EVS_ERROR,
            "CS Tables: Problem Getting table name info Share: 0x00000000, "
            "GetInfo: 0x00000000, GetAddress: 0xCC000005"),
        "CS Tables: Problem Getting table name info Share: 0x00000000, "
        "GetInfo: 0x00000000, GetAddress: 0xCC000005");
...
void CS_ComputeTables_Test_TableUnregisteredAndNeverLoaded(void) {
    ...
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETINFO_INDEX, CFE_TBL_ERR_UNREGISTERED,
                             1);

    /* Satisfies second instance of conditions "Result ==
     * CFE_TBL_ERR_UNREGISTERED" and "ResultGetAddress ==
     * CFE_TBL_ERR_NEVER_LOADED" */
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_GETADDRESS_INDEX,
                               &CS_COMPUTE_TEST_CFE_TBL_GetAddressHook);
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX,
                             CFE_TBL_ERR_NEVER_LOADED, 2);
    ...
    UtAssert_True(ResultsEntry.TempChecksumValue == 0,
                  "ResultsEntry.TempChecksumValue == 0");
    UtAssert_True(ResultsEntry.ComputedYet == FALSE,
                  "ResultsEntry.ComputedYet == FALSE");
    UtAssert_True(ResultsEntry.ComparisonValue == 0,
                  "ResultsEntry.ComparisonValue == 0");
    UtAssert_True(ResultsEntry.StartAddress == 0,
                  "ResultsEntry.StartAddress == 0");
    UtAssert_True(ResultsEntry.NumBytesToChecksum == 0,
...
void CS_ComputeTables_Test_ResultShareNotSuccess(void) {
    ...
    /* Set to satisfy second instance of condition "ResultGetAddress ==
     * CFE_TBL_ERR_NEVER_LOADED" */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX,
                             CFE_TBL_ERR_UNREGISTERED, 1);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_COMPUTE_TABLES_ERR_EID, CFE_EVS_ERROR,
            "CS Tables: Problem Getting table name info Share: 0xFFFFFFFF, "
            "GetInfo: 0xCC000009, GetAddress: 0xCC000009"),
        "CS Tables: Problem Getting table name info Share: 0xFFFFFFFF, "
        "GetInfo: 0xCC000009, GetAddress: 0xCC000009");
...
void CS_ComputeTables_Test_TblInfoUpdated(void) {
    ...
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_GETINFO_INDEX,
                               &CS_COMPUTE_TEST_CFE_TBL_GetInfoHook1);
    ...
    UtAssert_True(ResultsEntry.NumBytesToChecksum == 5,
                  "ResultsEntry.NumBytesToChecksum == 5");
    UtAssert_True(ResultsEntry.StartAddress == 0,
                  "ResultsEntry.StartAddress == 0");
...
void CS_ComputeTables_Test_CSError(void) {
    ...
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_GETINFO_INDEX,
                               &CS_COMPUTE_TEST_CFE_TBL_GetInfoHook2);
...
void CS_ComputeTables_Test_NominalBadTableHandle(void) {
    ...
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_SHARE_INDEX,
                               &CS_COMPUTE_TEST_CFE_TBL_ShareHook);
...
void CS_ComputeTables_Test_FirstTimeThrough(void) {
    ...
    UtAssert_True(ResultsEntry.ComputedYet == TRUE,
                  "ResultsEntry.ComputedYet == TRUE");
    UtAssert_True(ResultsEntry.ComparisonValue == 3,
...
void CS_ComputeTables_Test_EntryNotFinished(void) {
    ...
    UtAssert_True(ResultsEntry.TempChecksumValue == 3,
                  "ResultsEntry.TempChecksumValue == 3");
    UtAssert_True(ComputedCSValue == 3, "ComputedCSValue == 3");
...
void CS_ComputeTables_Test_ComputeTablesReleaseError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_COMPUTE_TABLES_RELEASE_ERR_EID, CFE_EVS_ERROR,
                             "CS Tables: Could not release addresss for table "
                             "name, returned: 0xFFFFFFFF"),
        "CS Tables: Could not release addresss for table name, returned: "
        "0xFFFFFFFF");
...
void CS_ComputeTables_Test_ComputeTablesError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_COMPUTE_TABLES_ERR_EID, CFE_EVS_ERROR,
            "CS Tables: Problem Getting table name info Share: 0x00000000, "
            "GetInfo: 0x00000000, GetAddress: 0xFFFFFFFF"),
        "CS Tables: Problem Getting table name info Share: 0x00000000, "
        "GetInfo: 0x00000000, GetAddress: 0xFFFFFFFF");
...
void CS_ComputeApp_Test_Nominal(void) {
    ...
    Ut_CFE_ES_SetFunctionHook(UT_CFE_ES_GETAPPINFO_INDEX,
                              &CS_COMPUTE_TEST_CFE_ES_GetAppInfoHook1);
    ...
    UtAssert_True(ResultsEntry.NumBytesToChecksum == 5,
                  "ResultsEntry.NumBytesToChecksum == 5");
    UtAssert_True(ResultsEntry.StartAddress == 1,
                  "ResultsEntry.StartAddress == 1");
...
void CS_ComputeApp_Test_GetAppIDByNameError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_COMPUTE_APP_ERR_EID, CFE_EVS_ERROR,
                      "CS Apps: Problems getting app name info, GetAppID: "
                      "0xFFFFFFFF, GetAppInfo: 0xFFFFFFFF, AddressValid: 0"),
                  "CS Apps: Problems getting app name info, GetAppID: "
                  "0xFFFFFFFF, GetAppInfo: 0xFFFFFFFF, AddressValid: 0");
...
void CS_ComputeApp_Test_GetAppInfoError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_COMPUTE_APP_ERR_EID, CFE_EVS_ERROR,
                      "CS Apps: Problems getting app name info, GetAppID: "
                      "0x00000000, GetAppInfo: 0xFFFFFFFF, AddressValid: 0"),
                  "CS Apps: Problems getting app name info, GetAppID: "
                  "0x00000000, GetAppInfo: 0xFFFFFFFF, AddressValid: 0");
...
void CS_ComputeApp_Test_ComputeAppPlatformError(void) {
    ...
    Ut_CFE_ES_SetFunctionHook(UT_CFE_ES_GETAPPINFO_INDEX,
                              &CS_COMPUTE_TEST_CFE_ES_GetAppInfoHook2);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_COMPUTE_APP_PLATFORM_DBG_EID, CFE_EVS_DEBUG,
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_COMPUTE_APP_ERR_EID, CFE_EVS_ERROR,
                      "CS Apps: Problems getting app name info, GetAppID: "
                      "0x00000000, GetAppInfo: 0x00000000, AddressValid: 0"),
                  "CS Apps: Problems getting app name info, GetAppID: "
                  "0x00000000, GetAppInfo: 0x00000000, AddressValid: 0");
...
void CS_ComputeApp_Test_FirstTimeThrough(void) {
    ...
    UtAssert_True(ResultsEntry.ComputedYet == TRUE,
                  "ResultsEntry.ComputedYet == TRUE");
    UtAssert_True(ResultsEntry.ComparisonValue == 2,
                  "ResultsEntry.ComparisonValue == 2");
...
void CS_ComputeApp_Test_EntryNotFinished(void) {
    ...
    UtAssert_True(ResultsEntry.ByteOffset == 3, "ResultsEntry.ByteOffset == 3");
    UtAssert_True(ResultsEntry.TempChecksumValue == 2,
                  "ResultsEntry.TempChecksumValue == 2");
    UtAssert_True(ComputedCSValue == 2, "ComputedCSValue == 2");
...
void CS_RecomputeEepromMemoryChildTask_Test_EEPROMTable(void) {
    ...
    RecomputeEepromMemoryEntry.StartAddress =
        CS_AppData.DefEepromTblPtr[1].StartAddress;
    ...
    /* Set to a value, which will be printed in message
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.RecomputeInProgress == FALSE,
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID, CFE_EVS_INFORMATION,
...
void CS_RecomputeEepromMemoryChildTask_Test_MemoryTable(void) {
    ...
    RecomputeEepromMemoryEntry.StartAddress =
        CS_AppData.DefMemoryTblPtr[1].StartAddress;
...
void CS_RecomputeEepromMemoryChildTask_Test_CFECore(void) {
    ...
    UtAssert_True(CS_AppData.CfeCoreBaseline == 1,
                  "CS_AppData.CfeCoreBaseline == 1");
...
void CS_RecomputeEepromMemoryChildTask_Test_RegisterChildTaskError(void) {
    /* Set to cause message "Recompute for Eeprom or Memory Child Task
     * Registration failed!" to be printed */
    ...
    /* Verify results */
    /* Note: Cannot verify line OS_printf("Recompute for Eeprom or Memory Child
...
void CS_RecomputeAppChildTask_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.RecomputeAppEntryPtr->State == 99,
                  "CS_AppData.RecomputeAppEntryPtr->State == 99");
    UtAssert_True(
    ...
    UtAssert_True(CS_AppData.RecomputeAppEntryPtr->ByteOffset == 0,
                  "CS_AppData.RecomputeAppEntryPtr->ByteOffset == 0");
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_RECOMPUTE_FINISH_APP_INF_EID, CFE_EVS_INFORMATION,
...
void CS_RecomputeAppChildTask_Test_CouldNotGetAddress(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_ERROR_APP_ERR_EID, CFE_EVS_ERROR,
...
void CS_RecomputeAppChildTask_Test_RegisterChildTaskError(void) {
    /* Set to cause message "Recompute for App Child Task Registration failed!"
     * to be printed */
    Ut_CFE_ES_SetReturnCode(UT_CFE_ES_REGISTERCHILDTASK_INDEX, -1, 1);
    ...
    /* Verify results */
    /* Note: Cannot verify line OS_printf("Recompute for App Child Task
     * Registration failed!\n") */
    UtAssert_True(CS_AppData.RecomputeInProgress == FALSE,
                  "CS_AppData.RecomputeInProgress == FALSE");
...
void CS_RecomputeTablesChildTask_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.RecomputeTablesEntryPtr->State == 99,
                  "CS_AppData.RecomputeTablesEntryPtr->State == 99");
    UtAssert_True(
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_RECOMPUTE_FINISH_TABLES_INF_EID, CFE_EVS_INFORMATION,
...
void CS_RecomputeTablesChildTask_Test_CouldNotGetAddress(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_ERROR_TABLES_ERR_EID, CFE_EVS_ERROR,
...
void CS_RecomputeTablesChildTask_Test_RegisterChildTaskError(void) {
    /* Set to cause message "Recompute Tables Child Task Registration failed!"
     * to be printed */
    Ut_CFE_ES_SetReturnCode(UT_CFE_ES_REGISTERCHILDTASK_INDEX, -1, 1);
    ...
    /* Verify results */
    /* Note: Cannot verify line OS_printf("Recompute Tables Child Task
     * Registration failed!\n") */
    UtAssert_True(CS_AppData.RecomputeInProgress == FALSE,
                  "CS_AppData.RecomputeInProgress == FALSE");
...
void CS_OneShotChildTask_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.LastOneShotChecksum == 1,
                  "CS_AppData.LastOneShotChecksum == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ONESHOT_FINISHED_INF_EID, CFE_EVS_INFORMATION,
                             "OneShot checksum on Address: 0x00000000, size 1 "
                             "completed. Checksum =  0x00000001"),
        "OneShot checksum on Address: 0x00000000, size 1 completed. Checksum = "
        " 0x00000001");

    UtAssert_True(CS_AppData.RecomputeInProgress == FALSE,
                  "CS_AppData.RecomputeInProgress == FALSE");
    UtAssert_True(CS_AppData.OneShotInProgress == FALSE,
...
void CS_OneShotChildTask_Test_RegisterChildTaskError(void) {
    /* Set to cause message "OneShot Child Task Registration failed!" to be
     * printed */
    Ut_CFE_ES_SetReturnCode(UT_CFE_ES_REGISTERCHILDTASK_INDEX, -1, 1);
    ...
    /* Verify results */
    /* Note: Cannot verify line OS_printf("OneShot Child Task Registration
     * failed!\n") */
    UtAssert_True(CS_AppData.RecomputeInProgress == FALSE,
                  "CS_AppData.RecomputeInProgress == FALSE");
    UtAssert_True(CS_AppData.OneShotInProgress == FALSE,
...
void CS_Compute_Test_AddTestCases(void) {
    UtTest_Add(CS_ComputeEepromMemory_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeEepromMemory_Test_Nominal");
    UtTest_Add(CS_ComputeEepromMemory_Test_Error, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeEepromMemory_Test_Error");
    UtTest_Add(CS_ComputeEepromMemory_Test_FirstTimeThrough, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ComputeEepromMemory_Test_FirstTimeThrough");
    UtTest_Add(CS_ComputeEepromMemory_Test_NotFinished, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeEepromMemory_Test_NotFinished");

    UtTest_Add(CS_ComputeTables_Test_TableNeverLoaded, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeTables_Test_TableNeverLoaded");
    ...
    UtTest_Add(CS_ComputeTables_Test_ResultShareNotSuccess, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeTables_Test_ResultShareNotSuccess");
    UtTest_Add(CS_ComputeTables_Test_TblInfoUpdated, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeTables_Test_TblInfoUpdated");
    UtTest_Add(CS_ComputeTables_Test_CSError, CS_Test_Setup, CS_Test_TearDown,
               "CS_ComputeTables_Test_CSError");
    UtTest_Add(CS_ComputeTables_Test_NominalBadTableHandle, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeTables_Test_NominalBadTableHandle");
    UtTest_Add(CS_ComputeTables_Test_FirstTimeThrough, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeTables_Test_FirstTimeThrough");
    UtTest_Add(CS_ComputeTables_Test_EntryNotFinished, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeTables_Test_EntryNotFinished");
    UtTest_Add(CS_ComputeTables_Test_ComputeTablesReleaseError, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ComputeTables_Test_ComputeTablesReleaseError");
    UtTest_Add(CS_ComputeTables_Test_ComputeTablesError, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeTables_Test_ComputeTablesError");

    UtTest_Add(CS_ComputeApp_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_ComputeApp_Test_Nominal");
    UtTest_Add(CS_ComputeApp_Test_GetAppIDByNameError, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeApp_Test_GetAppIDByNameError");
    UtTest_Add(CS_ComputeApp_Test_GetAppInfoError, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeApp_Test_GetAppInfoError");
    UtTest_Add(CS_ComputeApp_Test_ComputeAppPlatformError, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeApp_Test_ComputeAppPlatformError");
    UtTest_Add(CS_ComputeApp_Test_DifferFromSavedValue, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeApp_Test_DifferFromSavedValue");
    UtTest_Add(CS_ComputeApp_Test_FirstTimeThrough, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeApp_Test_FirstTimeThrough");
    UtTest_Add(CS_ComputeApp_Test_EntryNotFinished, CS_Test_Setup,
               CS_Test_TearDown, "CS_ComputeApp_Test_EntryNotFinished");
    ...
    UtTest_Add(CS_RecomputeEepromMemoryChildTask_Test_CFECore, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeEepromMemoryChildTask_Test_CFECore");
    UtTest_Add(CS_RecomputeEepromMemoryChildTask_Test_OSCore, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeEepromMemoryChildTask_Test_OSCore");
    UtTest_Add(CS_RecomputeEepromMemoryChildTask_Test_RegisterChildTaskError,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_RecomputeEepromMemoryChildTask_Test_RegisterChildTaskError");

    UtTest_Add(CS_RecomputeAppChildTask_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeAppChildTask_Test_Nominal");
    UtTest_Add(CS_RecomputeAppChildTask_Test_CouldNotGetAddress, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeAppChildTask_Test_CouldNotGetAddress");
    UtTest_Add(CS_RecomputeAppChildTask_Test_RegisterChildTaskError,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_RecomputeAppChildTask_Test_RegisterChildTaskError");

    UtTest_Add(CS_RecomputeTablesChildTask_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeTablesChildTask_Test_Nominal");
    UtTest_Add(CS_RecomputeTablesChildTask_Test_CouldNotGetAddress,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_RecomputeTablesChildTask_Test_CouldNotGetAddress");
    UtTest_Add(CS_RecomputeTablesChildTask_Test_RegisterChildTaskError,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_RecomputeTablesChildTask_Test_RegisterChildTaskError");

    UtTest_Add(CS_OneShotChildTask_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_OneShotChildTask_Test_Nominal");
    UtTest_Add(CS_OneShotChildTask_Test_RegisterChildTaskError, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_OneShotChildTask_Test_RegisterChildTaskError");
