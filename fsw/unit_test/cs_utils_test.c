...
int32 CS_UTILS_TEST_CFE_ES_GetAppInfoHook1(CFE_ES_AppInfo_t *AppInfo,
                                           uint32 AppId) {
    AppInfo->CodeSize          = 5;
...
void CS_ZeroEepromTempValues_Test(void) {
    ...
    UtAssert_True(
        CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES / 2]
                .TempChecksumValue == 0,
        "CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES/"
        "2].TempChecksumValue == 0");
    UtAssert_True(
        CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES / 2]
                .ByteOffset == 0,
        "CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES/"
        "2].ByteOffset == 0");
    UtAssert_True(
        CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES - 1]
                .TempChecksumValue == 0,
        "CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES-1]."
        "TempChecksumValue == 0");
    UtAssert_True(
...
void CS_ZeroMemoryTempValues_Test(void) {
    ...
    UtAssert_True(
        CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES / 2]
                .TempChecksumValue == 0,
        "CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES/"
        "2].TempChecksumValue == 0");
    UtAssert_True(
        CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES / 2]
                .ByteOffset == 0,
        ...
        "2].ByteOffset == 0");
    UtAssert_True(
        CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES - 1]
                .TempChecksumValue == 0,
        "CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES-1]."
        "TempChecksumValue == 0");
    UtAssert_True(
...
void CS_ZeroTablesTempValues_Test(void) {
    ...
    UtAssert_True(
        CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES / 2]
                .TempChecksumValue == 0,
        "CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES/"
        "2].TempChecksumValue == 0");
    UtAssert_True(
        CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES / 2]
                .ByteOffset == 0,
        ...
        "2].ByteOffset == 0");
    UtAssert_True(
        CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES - 1]
                .TempChecksumValue == 0,
        "CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES-1]."
        "TempChecksumValue == 0");
    UtAssert_True(
...
void CS_ZeroAppTempValues_Test(void) {
    ...
    UtAssert_True(CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                          .TempChecksumValue == 0,
                  "CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES/"
                  "2].TempChecksumValue == 0");
    UtAssert_True(
        CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES / 2].ByteOffset ==
            0,
        "CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES/2].ByteOffset == "
        "0");
    UtAssert_True(CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES - 1]
                          .TempChecksumValue == 0,
                  "CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES-1]."
                  "TempChecksumValue == 0");
    UtAssert_True(
        CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES - 1].ByteOffset ==
            0,
        "CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES-1].ByteOffset == "
        "0");
...
void CS_ZeroCfeCoreTempValues_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CfeCoreCodeSeg.TempChecksumValue == 0,
                  "CS_AppData.CfeCoreCodeSeg.TempChecksumValue == 0");
    UtAssert_True(CS_AppData.CfeCoreCodeSeg.ByteOffset == 0,
...
void CS_ZeroOSTempValues_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.OSCodeSeg.TempChecksumValue == 0,
                  "CS_AppData.OSCodeSeg.TempChecksumValue == 0");
    UtAssert_True(CS_AppData.OSCodeSeg.ByteOffset == 0,
...
void CS_InitializeDefaultTables_Test(void) {
    ...
    UtAssert_True(
        CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .State == CS_STATE_EMPTY,
        "CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES/"
        "2].State == CS_STATE_EMPTY");
    UtAssert_True(
        CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .NumBytesToChecksum == 0,
        "CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES/"
        "2].NumBytesToChecksum == 0");
    UtAssert_True(
        CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .StartAddress == 0,
        "CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES/"
    ...
    UtAssert_True(
        CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES - 1]
                .State == CS_STATE_EMPTY,
        "CS_AppData.DefaultEepromDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES-1]."
        "State == CS_STATE_EMPTY");
    UtAssert_True(
    ...
    UtAssert_True(
        CS_AppData.DefaultMemoryDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .State == CS_STATE_EMPTY,
        "CS_AppData.DefaultMemoryDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES/"
        "2].State == CS_STATE_EMPTY");
    UtAssert_True(
        CS_AppData.DefaultMemoryDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .NumBytesToChecksum == 0,
    ...
    UtAssert_True(
        CS_AppData.DefaultMemoryDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES - 1]
                .State == CS_STATE_EMPTY,
        "CS_AppData.DefaultMemoryDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES-1]."
        "State == CS_STATE_EMPTY");
    UtAssert_True(
    ...
    UtAssert_True(CS_AppData.DefaultAppDefTable[0].Name[0] == '\0',
                  "CS_AppData.DefaultAppDefTable[0].Name[0] == '\0'");

    UtAssert_True(
        CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2].State ==
            CS_STATE_EMPTY,
        "CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES/2].State "
        "== CS_STATE_EMPTY");
    UtAssert_True(
        CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .Name[0] == '\0',
        "CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES/2].Name[0] "
        "== '\0'");

    UtAssert_True(
        CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES - 1].State ==
            CS_STATE_EMPTY,
        "CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES-1].State "
        "== CS_STATE_EMPTY");
    UtAssert_True(
        CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES - 1]
                .Name[0] == '\0',
        "CS_AppData.DefaultAppDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES-1].Name[0] "
        "== '\0'");

    UtAssert_True(
        CS_AppData.DefaultTablesDefTable[0].State == CS_STATE_EMPTY,
        "CS_AppData.DefaultTablesDefTable[0].State == CS_STATE_EMPTY");
    UtAssert_True(CS_AppData.DefaultTablesDefTable[0].Name[0] == '\0',
                  "CS_AppData.DefaultTablesDefTable[0].Name[0] == '\0'");

    UtAssert_True(
        CS_AppData.DefaultTablesDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .State == CS_STATE_EMPTY,
        "CS_AppData.DefaultTablesDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES/"
        "2].State == CS_STATE_EMPTY");
    UtAssert_True(
        CS_AppData.DefaultTablesDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES / 2]
                .Name[0] == '\0',
    ...
    UtAssert_True(
        CS_AppData.DefaultTablesDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES - 1]
                .State == CS_STATE_EMPTY,
        "CS_AppData.DefaultTablesDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES-1]."
        "State == CS_STATE_EMPTY");
    UtAssert_True(
        CS_AppData.DefaultTablesDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES - 1]
                .Name[0] == '\0',
        "CS_AppData.DefaultTablesDefTable[CS_MAX_NUM_APP_TABLE_ENTRIES-1].Name["
        "0] == '\0'");
...
void CS_GoToNextTable_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CurrentCSTable == CS_NUM_TABLES - 1,
                  "CS_AppData.CurrentCSTable == CS_NUM_TABLES - 1");
    UtAssert_True(CS_AppData.CurrentEntryInTable == 0,
...
void CS_GoToNextTable_Test_UpdatePassCounter(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CurrentCSTable == 0,
...
void CS_GetTableResTblEntryByName_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(EntryPtr == CS_AppData.ResTablesTblPtr,
                  "EntryPtr == CS_AppData.ResTablesTblPtr");
...
void CS_GetTableDefTblEntryByName_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(EntryPtr == CS_AppData.DefTablesTblPtr,
...
void CS_GetAppResTblEntryByName_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(EntryPtr == CS_AppData.ResAppTblPtr,
...
void CS_GetAppDefTblEntryByName_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(EntryPtr == CS_AppData.DefAppTblPtr,
                  "EntryPtr == CS_AppData.DefAppTblPtr");
    UtAssert_True(Result == TRUE, "Result == TRUE");
...
void CS_FindEnabledEepromEntry_Test(void) {
    ...
    CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES].State =
        CS_STATE_ENABLED;
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CurrentEntryInTable == 16,
                  "CS_AppData.CurrentEntryInTable == 16");
    ...
    UtAssert_True(
        ...
        "memcmp(&CS_AppData.ResEepromTblPtr[0], "
        "&CS_AppData.ResEepromTblPtr[15], "
        "CS_MAX_NUM_EEPROM_TABLE_ENTRIES*sizeof(CS_Res_EepromMemory_Table_"
        "Entry_t))");
...
void CS_FindEnabledMemoryEntry_Test(void) {
    ...
    CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES].State =
        CS_STATE_ENABLED;
    ...
    UtAssert_True(
        memcmp(&CS_AppData.ResMemoryTblPtr[0], &CS_AppData.ResMemoryTblPtr[15],
               CS_MAX_NUM_MEMORY_TABLE_ENTRIES *
                   sizeof(CS_Res_EepromMemory_Table_Entry_t)),
        "memcmp(&CS_AppData.ResMemoryTblPtr[0], "
        "&CS_AppData.ResMemoryTblPtr[15], "
        "CS_MAX_NUM_MEMORY_TABLE_ENTRIES*sizeof(CS_Res_EepromMemory_Table_"
        "Entry_t))");
    UtAssert_True(EnabledEntry == 16, "EnabledEntry == 16");
...
void CS_FindEnabledTablesEntry_Test(void) {
    ...
    CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES].State =
        CS_STATE_ENABLED;
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CurrentEntryInTable == 24,
                  "CS_AppData.CurrentEntryInTable == 24");
    ...
    UtAssert_True(
        ...
        "memcmp(&CS_AppData.ResTablesTblPtr[0], "
        "&CS_AppData.ResTablesTblPtr[23], "
...
void CS_FindEnabledAppEntry_Test(void) {
    ...
    CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES].State =
        CS_STATE_ENABLED;
...
void CS_VerifyCmdLength_Test_Nominal(void) {
    ...
    /* Execute the function being tested */
    Result = CS_VerifyCmdLength((CFE_SB_MsgPtr_t)(&CmdPacket),
                                sizeof(CS_OneShotCmd_t));
...
void CS_VerifyCmdLength_Test_InvalidMsgLength(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_LEN_ERR_EID, CFE_EVS_ERROR,
                             "Invalid msg length: ID = 0x189F, CC = 88, Len = "
                             "20, Expected = 99"),
        "Invalid msg length: ID = 0x189F, CC = 88, Len = 20, Expected = 99");

    UtAssert_True(CS_AppData.CmdErrCounter == 1,
                  "CS_AppData.CmdErrCounter == 1");
...
void CS_BackgroundCfeCore_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CurrentEntryInTable == 0,
                  "CS_AppData.CurrentEntryInTable == 0"); /* Reset to 0 by
                                                             CS_GoToNextTable */
    UtAssert_True(
        CS_AppData.CfeCoreBaseline == 0,
        "CS_AppData.CfeCoreBaseline == 0"); /* Reset to 0 by
                                               CS_ComputeEepromMemory */
...
void CS_BackgroundCfeCore_Test_Miscompare(void) {
    ...
    /* Set to satisfy condition "NewChecksumValue != ResultsEntry ->
     * ComparisonValue" */
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CfeCoreCSErrCounter == 1,
                  "CS_AppData.CfeCoreCSErrCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_CFECORE_MISCOMPARE_ERR_EID, CFE_EVS_ERROR,
                             "Checksum Failure: cFE Core, Expected: "
                             "0x00000005, Calculated: 0x00000001"),
        "Checksum Failure: cFE Core, Expected: 0x00000005, Calculated: "
        "0x00000001");

    UtAssert_True(CS_AppData.CurrentEntryInTable == 0,
                  "CS_AppData.CurrentEntryInTable == 0"); /* Reset to 0 by
                                                             CS_GoToNextTable */
    UtAssert_True(CS_AppData.CfeCoreBaseline == 5,
                  "CS_AppData.CfeCoreBaseline == 5");
...
void CS_BackgroundOS_Test_Nominal(void) {
    ...
    UtAssert_True(CS_AppData.CurrentEntryInTable == 0,
                  "CS_AppData.CurrentEntryInTable == 0"); /* Reset to 0 by
                                                             CS_GoToNextTable */
    UtAssert_True(CS_AppData.OSBaseline == 0,
                  "CS_AppData.OSBaseline == 0"); /* Reset to 0 by
                                                    CS_ComputeEepromMemory */
...
void CS_BackgroundOS_Test_Miscompare(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.OSCSErrCounter == 1,
                  "CS_AppData.OSCSErrCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_OS_MISCOMPARE_ERR_EID, CFE_EVS_ERROR,
                             "Checksum Failure: OS code segment, Expected: "
                             "0x00000005, Calculated: 0x00000001"),
        "Checksum Failure: cFE Core, Expected: 0x00000005, Calculated: "
        "0x00000001");
...
void CS_BackgroundEeprom_Test_Nominal(void) {
    ...
    UtAssert_True(CS_AppData.CurrentEntryInTable == 0,
                  "CS_AppData.CurrentEntryInTable == 0"); /* Reset to 0 by
                                                             CS_GoToNextTable */
    UtAssert_True(CS_AppData.EepromBaseline == 1,
                  "CS_AppData.EepromBaseline == 1");
    UtAssert_True(Result == TRUE, "Result == TRUE");
...
void CS_BackgroundEeprom_Test_Miscompare(void) {
    ...
    CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES]
        .NumBytesToChecksum     = 1;
    CS_AppData.MaxBytesPerCycle = 2;
    CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES].ComputedYet =
        TRUE;
    CS_AppData.ResEepromTblPtr[CS_MAX_NUM_EEPROM_TABLE_ENTRIES]
        .ComparisonValue = 5;
    CS_AppData.ResEepromTblPtr[0].ComparisonValue =
        5; /* ResEepromTblPtr[0] is added to EntireEepromCS, ResEepromTblPtr[16]
              is not, because it's outside the valid range */
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.EepromCSErrCounter == 1,
                  "CS_AppData.EepromCSErrCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_EEPROM_MISCOMPARE_ERR_EID, CFE_EVS_ERROR,
                             "Checksum Failure: Entry 16 in Eeprom Table, "
                             "Expected: 0x00000005, Calculated: 0x00000001"),
        "Checksum Failure: Entry 16 in Eeprom Table, Expected: 0x00000005, "
        "Calculated: 0x00000001");

    UtAssert_True(CS_AppData.CurrentEntryInTable == 0,
                  "CS_AppData.CurrentEntryInTable == 0"); /* Reset to 0 by
                                                             CS_GoToNextTable */
    UtAssert_True(CS_AppData.EepromBaseline == 5,
                  "CS_AppData.EepromBaseline == 5");
...
void CS_BackgroundMemory_Test_Miscompare(void) {
    ...
    CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES]
        .NumBytesToChecksum     = 1;
    CS_AppData.MaxBytesPerCycle = 2;
    CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES].ComputedYet =
        TRUE;
    CS_AppData.ResMemoryTblPtr[CS_MAX_NUM_MEMORY_TABLE_ENTRIES]
        .ComparisonValue = 5;
    CS_AppData.ResMemoryTblPtr[0].ComparisonValue =
        5; /* ResMemoryTblPtr[0] is added to EntireMemoryCS, ResMemoryTblPtr[16]
              is not, because it's outside the valid range */
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.MemoryCSErrCounter == 1,
                  "CS_AppData.MemoryCSErrCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_MEMORY_MISCOMPARE_ERR_EID, CFE_EVS_ERROR,
                             "Checksum Failure: Entry 16 in Memory Table, "
                             "Expected: 0x00000005, Calculated: 0x00000001"),
        "Checksum Failure: Entry 16 in Memory Table, Expected: 0x00000005, "
        "Calculated: 0x00000001");
...
void CS_BackgroundTables_Test_Miscompare(void) {
    ...
    strncpy(CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES].Name,
            "name", 10);
    ...
    CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES].ComputedYet =
        TRUE;

    CS_AppData.ResTablesTblPtr[CS_MAX_NUM_TABLES_TABLE_ENTRIES]
        .ComparisonValue = 1;

    /* Set to satisfy condition "Result == CFE_SUCCESS" and to fail other
     * conditions that check for other values of Result */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, CFE_SUCCESS, 1);
    Ut_CFE_TBL_ContinueReturnCodeAfterCountZero(UT_CFE_TBL_GETADDRESS_INDEX);

    /* Set to fail condition "NewChecksumValue != ResultsEntry ->
     * ComparisonValue" */
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.TablesCSErrCounter == 1,
                  "CS_AppData.TablesCSErrCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_TABLES_MISCOMPARE_ERR_EID, CFE_EVS_ERROR,
                             "Checksum Failure: Table name, Expected: "
                             "0x00000001, Calculated: 0x00000002"),
        "Checksum Failure: Table name, Expected: 0x00000001, Calculated: "
        "0x00000002");
...
void CS_BackgroundTables_Test_TablesNotFound(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_COMPUTE_TABLES_NOT_FOUND_ERR_EID, CFE_EVS_ERROR,
            "Tables table computing: Table name could not be found, skipping"),
        "Tables table computing: Table name could not be found, skipping");

    UtAssert_True(CS_AppData.CurrentEntryInTable == 1,
                  "CS_AppData.CurrentEntryInTable == 1");
...
void CS_BackgroundApp_Test_Miscompare(void) {
    ...
    strncpy(CS_AppData.ResAppTblPtr[CS_MAX_NUM_APP_TABLE_ENTRIES].Name, "name",
            10);
    ...
    /* Sets AppInfo.CodeSize = 5, sets AppInfo.CodeAddress = 1,
     * AppInfo.AddressesAreValid = TRUE, and returns CFE_SUCCESS */
    Ut_CFE_ES_SetFunctionHook(UT_CFE_ES_GETAPPINFO_INDEX,
                              &CS_UTILS_TEST_CFE_ES_GetAppInfoHook1);
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.AppCSErrCounter == 1,
                  "CS_AppData.AppCSErrCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_APP_MISCOMPARE_ERR_EID, CFE_EVS_ERROR,
                             "Checksum Failure: Application name, Expected: "
                             "0x00000003, Calculated: 0x00000002"),
        "Checksum Failure: Application name, Expected: 0x00000003, Calculated: "
        "0x00000002");
...
void CS_Utils_Test_AddTestCases(void) {
    UtTest_Add(CS_ZeroEepromTempValues_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_ZeroEepromTempValues_Test");

    UtTest_Add(CS_ZeroMemoryTempValues_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_ZeroMemoryTempValues_Test");

    UtTest_Add(CS_ZeroTablesTempValues_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_ZeroTablesTempValues_Test");

    UtTest_Add(CS_ZeroAppTempValues_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_ZeroAppTempValues_Test");

    UtTest_Add(CS_ZeroCfeCoreTempValues_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_ZeroCfeCoreTempValues_Test");

    UtTest_Add(CS_ZeroOSTempValues_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_ZeroOSTempValues_Test");

    UtTest_Add(CS_InitializeDefaultTables_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_InitializeDefaultTables_Test");

    UtTest_Add(CS_GoToNextTable_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_GoToNextTable_Test_Nominal");
    UtTest_Add(CS_GoToNextTable_Test_UpdatePassCounter, CS_Test_Setup,
               CS_Test_TearDown, "CS_GoToNextTable_Test_UpdatePassCounter");

    UtTest_Add(CS_GetTableResTblEntryByName_Test, CS_Test_Setup,
               CS_Test_TearDown, "CS_GetTableResTblEntryByName_Test");

    UtTest_Add(CS_GetTableDefTblEntryByName_Test, CS_Test_Setup,
               CS_Test_TearDown, "CS_GetTableDefTblEntryByName_Test");

    UtTest_Add(CS_GetAppResTblEntryByName_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_GetAppResTblEntryByName_Test");

    UtTest_Add(CS_GetAppResTblEntryByName_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_GetAppDefTblEntryByName_Test");

    UtTest_Add(CS_FindEnabledEepromEntry_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_FindEnabledEepromEntry_Test");

    UtTest_Add(CS_FindEnabledMemoryEntry_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_FindEnabledMemoryEntry_Test");

    UtTest_Add(CS_FindEnabledTablesEntry_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_FindEnabledTablesEntry_Test");

    UtTest_Add(CS_FindEnabledAppEntry_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_FindEnabledAppEntry_Test");

    UtTest_Add(CS_VerifyCmdLength_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_VerifyCmdLength_Test_Nominal");
    UtTest_Add(CS_VerifyCmdLength_Test_InvalidMsgLength, CS_Test_Setup,
               CS_Test_TearDown, "CS_VerifyCmdLength_Test_InvalidMsgLength");

    UtTest_Add(CS_BackgroundCfeCore_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCfeCore_Test_Nominal");
    UtTest_Add(CS_BackgroundCfeCore_Test_Miscompare, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCfeCore_Test_Miscompare");
    UtTest_Add(CS_BackgroundCfeCore_Test_ResultsEntryDisabled, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_BackgroundCfeCore_Test_ResultsEntryDisabled");
    UtTest_Add(CS_BackgroundCfeCore_Test_CfeCoreCSStateDisabled, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_BackgroundCfeCore_Test_CfeCoreCSStateDisabled");

    UtTest_Add(CS_BackgroundOS_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_BackgroundOS_Test_Nominal");
    UtTest_Add(CS_BackgroundOS_Test_Miscompare, CS_Test_Setup, CS_Test_TearDown,
               "CS_BackgroundOS_Test_Miscompare");
    UtTest_Add(CS_BackgroundOS_Test_ResultsEntryDisabled, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundOS_Test_ResultsEntryDisabled");
    UtTest_Add(CS_BackgroundOS_Test_OSCSStateDisabled, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundOS_Test_OSCSStateDisabled");

    UtTest_Add(CS_BackgroundEeprom_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundEeprom_Test_Nominal");
    UtTest_Add(CS_BackgroundEeprom_Test_Miscompare, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundEeprom_Test_Miscompare");
    UtTest_Add(CS_BackgroundEeprom_Test_FindEnabledEepromEntryFalse,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_BackgroundEeprom_Test_FindEnabledEepromEntryFalse");
    UtTest_Add(CS_BackgroundEeprom_Test_EepromCSStateDisabled, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_BackgroundEeprom_Test_EepromCSStateDisabled");

    UtTest_Add(CS_BackgroundMemory_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundMemory_Test_Nominal");
    UtTest_Add(CS_BackgroundMemory_Test_Miscompare, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundMemory_Test_Miscompare");
    UtTest_Add(CS_BackgroundMemory_Test_FindEnabledMemoryEntryFalse,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_BackgroundMemory_Test_FindEnabledMemoryEntryFalse");
    UtTest_Add(CS_BackgroundMemory_Test_MemoryCSStateDisabled, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_BackgroundMemory_Test_MemoryCSStateDisabled");

    UtTest_Add(CS_BackgroundTables_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundTables_Test_Nominal");
    UtTest_Add(CS_BackgroundTables_Test_Miscompare, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundTables_Test_Miscompare");
    UtTest_Add(CS_BackgroundTables_Test_TablesNotFound, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundTables_Test_TablesNotFound");
    UtTest_Add(CS_BackgroundTables_Test_FindEnabledTablesEntryFalse,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_BackgroundTables_Test_FindEnabledTablesEntryFalse");
    UtTest_Add(CS_BackgroundTables_Test_TablesCSStateDisabled, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_BackgroundTables_Test_TablesCSStateDisabled");

    UtTest_Add(CS_BackgroundApp_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_BackgroundApp_Test_Nominal");
    UtTest_Add(CS_BackgroundApp_Test_Miscompare, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundApp_Test_Miscompare");
    UtTest_Add(CS_BackgroundApp_Test_AppNotFound, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundApp_Test_AppNotFound");
    UtTest_Add(CS_BackgroundApp_Test_FindEnabledAppEntryFalse, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_BackgroundApp_Test_FindEnabledAppEntryFalse");
    UtTest_Add(CS_BackgroundApp_Test_AppCSStateDisabled, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundApp_Test_AppCSStateDisabled");

    UtTest_Add(CS_ResetTablesTblResultEntry_Test, CS_Test_Setup,
               CS_Test_TearDown, "CS_ResetTablesTblResultEntry_Test");
