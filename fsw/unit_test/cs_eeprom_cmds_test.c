...
void CS_DisableEepromCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_EEPROM_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableEepromCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_EEPROM_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineEntryIDEepromCmd_Test_Computed(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_BASELINE_EEPROM_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineEntryIDEepromCmd_Test_NotYetComputed(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_NO_BASELINE_EEPROM_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineEntryIDEepromCmd_Test_InvalidEntryErrorEntryIDTooHigh(
    void) {
    CS_EntryCmd_t CmdPacket;
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_BASELINE_INVALID_ENTRY_EEPROM_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Eeprom report baseline failed, Entry "
                                       "ID invalid: 16, State: 3 Max ID: 15"),
                  "Eeprom report baseline failed, Entry ID invalid: 16, State: "
                  "3 Max ID: 15");
...
void CS_ReportBaselineEntryIDEepromCmd_Test_InvalidEntryErrorStateEmpty(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_BASELINE_INVALID_ENTRY_EEPROM_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Eeprom report baseline failed, Entry "
                                       "ID invalid: 1, State: 0 Max ID: 15"),
                  "Eeprom report baseline failed, Entry ID invalid: 1, State: "
                  "0 Max ID: 15");
...
void CS_RecomputeBaselineEepromCmd_Test_Nominal(void) {
    ...
    UtAssert_True(CS_AppData.ChildTaskTable == CS_EEPROM_TABLE,
                  "CS_AppData.ChildTaskTable == CS_EEPROM_TABLE");
    UtAssert_True(CS_AppData.ChildTaskEntryID == CmdPacket.EntryID,
                  "CS_AppData.ChildTaskEntryID == CmdPacket.EntryID");
    UtAssert_True(CS_AppData.RecomputeEepromMemoryEntryPtr ==
                      &CS_AppData.ResEepromTblPtr[CmdPacket.EntryID],
                  "CS_AppData.RecomputeEepromMemoryEntryPtr == "
                  "&CS_AppData.ResEepromTblPtr[CmdPacket.EntryID]");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_EEPROM_STARTED_DBG_EID, CFE_EVS_DEBUG,
...
void CS_RecomputeBaselineEepromCmd_Test_CreateChildTaskError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_EEPROM_CREATE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                      "Recompute baseline of Eeprom Entry ID 1 failed, "
...
void CS_RecomputeBaselineEepromCmd_Test_InvalidEntryErrorEntryIDTooHigh(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_INVALID_ENTRY_EEPROM_ERR_EID, CFE_EVS_ERROR,
                      "Eeprom recompute baseline of entry failed, Entry ID "
                      "invalid: 16, State: 3, Max ID: 15"),
                  "Eeprom recompute baseline of entry failed, Entry ID "
                  "invalid: 16, State: 3, Max ID: 15");
...
void CS_RecomputeBaselineEepromCmd_Test_RecomputeInProgress(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_EEPROM_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                             "Recompute baseline of Eeprom Entry ID 1 failed: "
                             "child task in use"),
...
void CS_EnableEntryIDEepromCmd_Test_Nominal(void) {
    ...
    UtAssert_True(
        ...
        "CS_AppData.ResEepromTblPtr[CmdPacket.EntryID].State == "
        "CS_STATE_ENABLED");
    ...
    UtAssert_True(
        ...
        "CS_AppData.DefEepromTblPtr[CmdPacket.EntryID].State == "
        "CS_STATE_ENABLED");
...
void CS_EnableEntryIDEepromCmd_Test_DefEepromTblPtrStateEmpty(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_EEPROM_DEF_EMPTY_DBG_EID, CFE_EVS_DEBUG,
                             "CS unable to update Eeprom definition table for "
                             "entry 1, State: 0"),
...
void CS_EnableEntryIDEepromCmd_Test_InvalidEntryErrorEntryIDTooHigh(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_ENABLE_EEPROM_INVALID_ENTRY_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Enable Eeprom entry failed, invalid "
                                       "Entry ID:  16, State: 3, Max ID: 15"),
                  "Enable Eeprom entry failed, invalid Entry ID:  16, State: "
                  "3, Max ID: 15");
...
void CS_EnableEntryIDEepromCmd_Test_InvalidEntryErrorStateEmpty(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_ENABLE_EEPROM_INVALID_ENTRY_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Enable Eeprom entry failed, invalid "
                                       "Entry ID:  1, State: 0, Max ID: 15"),
                  "Enable Eeprom entry failed, invalid Entry ID:  1, State: 0, "
                  "Max ID: 15");
...
void CS_DisableEntryIDEepromCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.ResEepromTblPtr[CmdPacket.EntryID].State ==
                      CS_STATE_DISABLED,
                  "CS_AppData.ResEepromTblPtr[CmdPacket.EntryID].State == "
                  "CS_STATE_DISABLED");
    UtAssert_True(
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_DISABLE_EEPROM_ENTRY_INF_EID, CFE_EVS_INFORMATION,
                      "Checksumming of Eeprom Entry ID 1 is Disabled"),
                  "Checksumming of Eeprom Entry ID 1 is Disabled");

    UtAssert_True(CS_AppData.DefEepromTblPtr[CmdPacket.EntryID].State ==
                      CS_STATE_DISABLED,
                  "CS_AppData.DefEepromTblPtr[CmdPacket.EntryID].State == "
                  "CS_STATE_DISABLED");
...
void CS_DisableEntryIDEepromCmd_Test_DefEepromTblPtrStateEmpty(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_EEPROM_DEF_EMPTY_DBG_EID, CFE_EVS_DEBUG,
                             "CS unable to update Eeprom definition table for "
                             "entry 1, State: 0"),
        "CS unable to update Eeprom definition table for entry 1, State: 0");
...
void CS_DisableEntryIDEepromCmd_Test_InvalidEntryErrorEntryIDTooHigh(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_DISABLE_EEPROM_INVALID_ENTRY_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Disable Eeprom entry failed, invalid "
                                       "Entry ID:  16, State: 3, Max ID: 15"),
                  "Disable Eeprom entry failed, invalid Entry ID:  16, State: "
                  "3, Max ID: 15");
...
void CS_DisableEntryIDEepromCmd_Test_InvalidEntryErrorStateEmpty(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_DISABLE_EEPROM_INVALID_ENTRY_ERR_EID,
                                       ...
                                       "Disable Eeprom entry failed, invalid "
                                       "Entry ID:  1, State: 0, Max ID: 15"),
                  "Disable Eeprom entry failed, invalid Entry ID:  1, State: "
                  "0, Max ID: 15");
...
void CS_GetEntryIDEepromCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_GET_ENTRY_ID_EEPROM_INF_EID, CFE_EVS_INFORMATION,
...
void CS_GetEntryIDEepromCmd_Test_AddressNotFound(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_GET_ENTRY_ID_EEPROM_NOT_FOUND_INF_EID, CFE_EVS_INFORMATION,
...
void CS_Eeprom_Cmds_Test_AddTestCases(void) {
    UtTest_Add(CS_DisableEepromCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_DisableEepromCmd_Test");

    UtTest_Add(CS_EnableEepromCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_EnableEepromCmd_Test");

    UtTest_Add(CS_ReportBaselineEntryIDEepromCmd_Test_Computed, CS_Test_Setup,
               CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ReportBaselineEntryIDEepromCmd_Test_"
        "InvalidEntryErrorEntryIDTooHigh");
    UtTest_Add(
        CS_ReportBaselineEntryIDEepromCmd_Test_InvalidEntryErrorStateEmpty,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ReportBaselineEntryIDEepromCmd_Test_InvalidEntryErrorStateEmpty");

    UtTest_Add(CS_RecomputeBaselineEepromCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeBaselineEepromCmd_Test_Nominal");
    ...
    UtTest_Add(CS_EnableEntryIDEepromCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_EnableEntryIDEepromCmd_Test_Nominal");
    ...
    UtTest_Add(CS_DisableEntryIDEepromCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_DisableEntryIDEepromCmd_Test_Nominal");
    ...
    UtTest_Add(CS_GetEntryIDEepromCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_GetEntryIDEepromCmd_Test_Nominal");
    UtTest_Add(CS_GetEntryIDEepromCmd_Test_AddressNotFound, CS_Test_Setup,
               CS_Test_TearDown, "CS_GetEntryIDEepromCmd_Test_AddressNotFound");
