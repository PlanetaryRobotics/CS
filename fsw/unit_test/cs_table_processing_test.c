...
int32 CS_TABLE_PROCESSING_TEST_CFE_ES_GetAppNameHook1(const char *AppName,
                                                      uint32 AppId,
                                                      uint32 BufferLength) {
...
int32 CS_TABLE_PROCESSING_TEST_CFE_ES_GetAppNameHook2(const char *AppName,
                                                      uint32 AppId,
                                                      uint32 BufferLength) {
    uint16 i;
...
int32 CS_TABLE_PROCESSING_TEST_CFE_TBL_GetAddressHook(
    void **TblPtr, CFE_TBL_Handle_t TblHandle) {
    return CFE_SUCCESS;
}

int32 CS_TABLE_PROCESSING_TEST_CFE_TBL_LoadHook(CFE_TBL_Handle_t TblHandle,
...
void CS_ValidateEepromChecksumDefinitionTable_Test_Nominal(void) {
    ...
    CS_AppData.DefEepromTblPtr[0].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */

    /* Execute the function being tested */
    Result =
        CS_ValidateEepromChecksumDefinitionTable(CS_AppData.DefEepromTblPtr);

    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_EEPROM_INF_EID, CFE_EVS_INFORMATION,
                             "CS Eeprom Table verification results: good = 1, "
                             "bad = 0, unused = 15"),
...
void CS_ValidateEepromChecksumDefinitionTable_Test_IllegalChecksumRangeStateEnabled(
    void) {
    int32 Result;
    ...
    Ut_CFE_PSP_MEMRANGE_SetReturnCode(
        UT_CFE_PSP_MEMRANGE_MEMVALIDATERANGE_INDEX, -1, 1);
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_VAL_EEPROM_RANGE_ERR_EID, CFE_EVS_ERROR,
            "Eeprom Table Validate: Illegal checksum range found in Entry ID "
            "0, CFE_PSP_MemValidateRange returned: 0xFFFFFFFF"),
        "Eeprom Table Validate: Illegal checksum range found in Entry ID 0, "
        "CFE_PSP_MemValidateRange returned: 0xFFFFFFFF");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_EEPROM_INF_EID, CFE_EVS_INFORMATION,
                             "CS Eeprom Table verification results: good = 0, "
                             "bad = 1, unused = 15"),
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 2,
     ...
     CS_ValidateEepromChecksumDefinitionTable_Test_IllegalChecksumRangeStateEnabled
   */
...
void CS_ValidateEepromChecksumDefinitionTable_Test_IllegalStateField(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_EEPROM_STATE_ERR_EID, CFE_EVS_ERROR,
                             "Eeprom Table Validate: Illegal State Field "
                             "(0xFFFF) found in Entry ID 0"),
        "Eeprom Table Validate: Illegal State Field (0xFFFF) found in Entry ID "
        "0");
...
void CS_ValidateMemoryChecksumDefinitionTable_Test_Nominal(void) {
    ...
    CS_AppData.DefMemoryTblPtr[0].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */

    /* Execute the function being tested */
    Result =
        CS_ValidateMemoryChecksumDefinitionTable(CS_AppData.DefMemoryTblPtr);

    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_MEMORY_INF_EID, CFE_EVS_INFORMATION,
                             "CS Memory Table verification results: good = 1, "
                             "bad = 0, unused = 15"),
...
void CS_ValidateMemoryChecksumDefinitionTable_Test_IllegalChecksumRangeStateEnabled(
    void) {
    int32 Result;
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_VAL_MEMORY_RANGE_ERR_EID, CFE_EVS_ERROR,
            "Memory Table Validate: Illegal checksum range found in Entry ID "
            "0, CFE_PSP_MemValidateRange returned: 0xFFFFFFFF"),
        "Memory Table Validate: Illegal checksum range found in Entry ID 0, "
        "CFE_PSP_MemValidateRange returned: 0xFFFFFFFF");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_MEMORY_INF_EID, CFE_EVS_INFORMATION,
                             "CS Memory Table verification results: good = 0, "
                             "bad = 1, unused = 15"),
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 2,
     ...
     CS_ValidateMemoryChecksumDefinitionTable_Test_IllegalChecksumRangeStateEnabled
   */

void CS_ValidateMemoryChecksumDefinitionTable_Test_IllegalChecksumRangeStateDisabled(
    void) {
    int32 Result;
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 2,
     ...
     CS_ValidateMemoryChecksumDefinitionTable_Test_IllegalChecksumRangeStateDisabled
   */
...
void CS_ValidateMemoryChecksumDefinitionTable_Test_IllegalStateField(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_MEMORY_STATE_ERR_EID, CFE_EVS_ERROR,
                             "Memory Table Validate: Illegal State Field "
                             "(0xFFFF) found in Entry ID 0"),
        "Memory Table Validate: Illegal State Field (0xFFFF) found in Entry ID "
        "0");
...
void CS_ValidateTablesChecksumDefinitionTable_Test_Nominal(void) {
    ...
    CS_AppData.DefTablesTblPtr[0].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */
    ...
    /* Execute the function being tested */
    Result =
        CS_ValidateTablesChecksumDefinitionTable(CS_AppData.DefTablesTblPtr);

    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_TABLES_INF_EID, CFE_EVS_INFORMATION,
                             "CS Tables Table verification results: good = 1, "
                             "bad = 0, unused = 23"),
...
void CS_ValidateTablesChecksumDefinitionTable_Test_DuplicateNameStateEmpty(
    void) {
    int32 Result;
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_TABLES_DEF_TBL_DUPL_ERR_EID, CFE_EVS_ERROR,
                             "CS Tables Table Validate: Duplicate Name (name) "
                             "found at entries 1 and 0"),
        "CS Tables Table Validate: Duplicate Name (name) found at entries 1 "
        "and 0");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_TABLES_INF_EID, CFE_EVS_INFORMATION,
                             "CS Tables Table verification results: good = 0, "
                             "bad = 1, unused = 23"),
...
void CS_ValidateTablesChecksumDefinitionTable_Test_DuplicateNameStateEnabled(
    void) {
    int32 Result;
    ...
    CS_AppData.DefTablesTblPtr[0].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */
    CS_AppData.DefTablesTblPtr[1].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */
...
void CS_ValidateTablesChecksumDefinitionTable_Test_DuplicateNameStateDisabled(
    ...
    CS_AppData.DefTablesTblPtr[0].State =
        CS_STATE_DISABLED; /* All other states are empty by default, and so this
                              test also covers CS_STATE_EMPTY branch */
    CS_AppData.DefTablesTblPtr[1].State =
        CS_STATE_DISABLED; /* All other states are empty by default, and so this
                              test also covers CS_STATE_EMPTY branch */
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 2,
     ...
     CS_ValidateTablesChecksumDefinitionTable_Test_DuplicateNameStateDisabled */
...
void CS_ValidateTablesChecksumDefinitionTable_Test_IllegalStateField(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_TABLES_STATE_ERR_EID, CFE_EVS_ERROR,
                             "CS Tables Table Validate: Illegal State Field "
                             "(0xFFFF) found with name name"),
        "CS Tables Table Validate: Illegal State Field (0xFFFF) found with "
        "name name");
...
void CS_ValidateTablesChecksumDefinitionTable_Test_IllegalStateEmptyName(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_VAL_TABLES_DEF_TBL_ZERO_NAME_ERR_EID, CFE_EVS_ERROR,
                      "CS Tables Table Validate: Illegal State (0x0001) with "
                      "empty name at entry 0"),
                  "CS Tables Table Validate: Illegal State (0x0001) with empty "
                  "name at entry 0");
...
void CS_ValidateAppChecksumDefinitionTable_Test_Nominal(void) {
    ...
    CS_AppData.DefAppTblPtr[0].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_APP_INF_EID, CFE_EVS_INFORMATION,
                             "CS Apps Table verification results: good = 1, "
                             "bad = 0, unused = 23"),
...
void CS_ValidateAppChecksumDefinitionTable_Test_DuplicateNameStateEmpty(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_APP_DEF_TBL_DUPL_ERR_EID, CFE_EVS_ERROR,
                             "CS Apps Table Validate: Duplicate Name (name) "
                             "found at entries 1 and 0"),
        "CS Apps Table Validate: Duplicate Name (name) found at entries 1 and "
        "0");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_VAL_APP_INF_EID, CFE_EVS_INFORMATION,
                             "CS Apps Table verification results: good = 0, "
                             "bad = 1, unused = 23"),
...
void CS_ValidateAppChecksumDefinitionTable_Test_DuplicateNameStateEnabled(
    void) {
    int32 Result;
    ...
    CS_AppData.DefAppTblPtr[0].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */
    CS_AppData.DefAppTblPtr[1].State =
        CS_STATE_ENABLED; /* All other states are empty by default, and so this
                             test also covers CS_STATE_EMPTY branch */
...
void CS_ValidateAppChecksumDefinitionTable_Test_DuplicateNameStateDisabled(
    void) {
    int32 Result;
...
void CS_ValidateAppChecksumDefinitionTable_Test_IllegalStateField(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_VAL_APP_STATE_ERR_EID, CFE_EVS_ERROR,
                                       "CS Apps Table Validate: Illegal State "
                                       "Field (0xFFFF) found with name name"),
                  "CS Apps Table Validate: Illegal State Field (0xFFFF) found "
                  "with name name");
...
void CS_ValidateAppChecksumDefinitionTable_Test_IllegalStateEmptyName(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_VAL_APP_DEF_TBL_ZERO_NAME_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "CS Apps Table Validate: Illegal State "
                                       "(0x0001) with empty name at entry 0"),
                  "CS Apps Table Validate: Illegal State (0x0001) with empty "
                  "name at entry 0");
...
void CS_ProcessNewEepromMemoryDefinitionTable_Test_EEPROMTableNominal(void) {
    ...
    /* Execute the function being tested */
    /* Note: first 2 arguments are passed in as addresses of pointers in the
       source code, even though the variable types of the arguments are just
       pointers and the variable names of the arguments suggest that they're
       just pointers */
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.EepromCSState == 99,
                  "CS_AppData.EepromCSState == 99");

    UtAssert_True(CS_AppData.ResEepromTblPtr[0].State == 1,
                  "CS_AppData.ResEepromTblPtr[0].State == 1");
    ...
    UtAssert_True(CS_AppData.ResEepromTblPtr[0].ByteOffset == 0,
                  "CS_AppData.ResEepromTblPtr[0].ByteOffset == 0");
    UtAssert_True(CS_AppData.ResEepromTblPtr[0].TempChecksumValue == 0,
                  "CS_AppData.ResEepromTblPtr[0].TempChecksumValue == 0");
    UtAssert_True(CS_AppData.ResEepromTblPtr[0].StartAddress == 3,
                  "CS_AppData.ResEepromTblPtr[0].StartAddress == 3");
    ...
    UtAssert_True(CS_AppData.ResEepromTblPtr[1].ByteOffset == 0,
                  "CS_AppData.ResEepromTblPtr[1].ByteOffset == 0");
    UtAssert_True(CS_AppData.ResEepromTblPtr[1].TempChecksumValue == 0,
                  "CS_AppData.ResEepromTblPtr[1].TempChecksumValue == 0");
    UtAssert_True(CS_AppData.ResEepromTblPtr[1].StartAddress == 0,
                  "CS_AppData.ResEepromTblPtr[1].StartAddress == 0");
...
void CS_ProcessNewEepromMemoryDefinitionTable_Test_MemoryTableNominal(void) {
    ...
    /* Note: first 2 arguments are passed in as addresses of pointers in the
       ...
       just pointers */
    CS_ProcessNewEepromMemoryDefinitionTable(
        (CS_Def_EepromMemory_Table_Entry_t *)&CS_AppData.DefMemoryTblPtr,
        (CS_Res_EepromMemory_Table_Entry_t *)&CS_AppData.ResMemoryTblPtr,
        NumEntries, Table);

    /* Verify results */
    UtAssert_True(CS_AppData.MemoryCSState == 99,
                  "CS_AppData.MemoryCSState == 99");

    UtAssert_True(CS_AppData.ResMemoryTblPtr[0].State == 1,
                  "CS_AppData.ResMemoryTblPtr[0].State == 1");
    ...
    UtAssert_True(CS_AppData.ResMemoryTblPtr[0].ByteOffset == 0,
                  "CS_AppData.ResMemoryTblPtr[0].ByteOffset == 0");
    UtAssert_True(CS_AppData.ResMemoryTblPtr[0].TempChecksumValue == 0,
                  "CS_AppData.ResMemoryTblPtr[0].TempChecksumValue == 0");
    UtAssert_True(CS_AppData.ResMemoryTblPtr[0].StartAddress == 3,
                  "CS_AppData.ResMemoryTblPtr[0].StartAddress == 3");
    ...
    UtAssert_True(CS_AppData.ResMemoryTblPtr[1].ByteOffset == 0,
                  "CS_AppData.ResMemoryTblPtr[1].ByteOffset == 0");
    UtAssert_True(CS_AppData.ResMemoryTblPtr[1].TempChecksumValue == 0,
                  "CS_AppData.ResMemoryTblPtr[1].TempChecksumValue == 0");
    UtAssert_True(CS_AppData.ResMemoryTblPtr[1].StartAddress == 0,
                  "CS_AppData.ResMemoryTblPtr[1].StartAddress == 0");
...
void CS_ProcessNewEepromMemoryDefinitionTable_Test_EEPROMTableNoValidEntries(
    void) {
    /* Handles both cases of "DefEntry -> State" */
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_PROCESS_EEPROM_MEMORY_NO_ENTRIES_INF_EID,
                             CFE_EVS_INFORMATION,
...
void CS_ProcessNewEepromMemoryDefinitionTable_Test_MemoryTableNoValidEntries(
    void) {
    /* Handles both cases of "DefEntry -> State" */
...
void CS_ProcessNewTablesDefinitionTable_Test_DefEepromTableHandle(void) {
    ...
    /* Sets AppName to "CS" */
    Ut_CFE_ES_SetFunctionHook(UT_CFE_ES_GETAPPNAME_INDEX,
                              &CS_TABLE_PROCESSING_TEST_CFE_ES_GetAppNameHook1);
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.MemResTablesTblPtr == NULL,
                  "CS_AppData.MemResTablesTblPtr == NULL");
    UtAssert_True(CS_AppData.AppResTablesTblPtr == NULL,
                  "CS_AppData.AppResTablesTblPtr == NULL");
    UtAssert_True(CS_AppData.TblResTablesTblPtr == NULL,
    ...
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].State == 88,
                  "CS_AppData.ResTablesTblPtr[0].State == 88");
    ...
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].ByteOffset == 0,
                  "CS_AppData.ResTablesTblPtr[0].ByteOffset == 0");
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].TempChecksumValue == 0,
                  "CS_AppData.ResTablesTblPtr[0].TempChecksumValue == 0");
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].StartAddress == 0,
                  "CS_AppData.ResTablesTblPtr[0].StartAddress == 0");

    UtAssert_True(CS_AppData.ResTablesTblPtr[0].TblHandle == 11,
                  "CS_AppData.ResTablesTblPtr[0].TblHandle == 11");
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].IsCSOwner == TRUE,
                  "CS_AppData.ResTablesTblPtr[0].IsCSOwner == TRUE");
    UtAssert_True(
        strncmp(CS_AppData.ResTablesTblPtr[0].Name, "CS.DefEepromTbl", 20) == 0,
        "strncmp(CS_AppData.ResTablesTblPtr[0].Name, 'CS.DefEepromTbl', 20) == "
        "0");

    UtAssert_True(CS_AppData.TablesCSState == 99,
                  "CS_AppData.TablesCSState == 99");
...
void CS_ProcessNewTablesDefinitionTable_Test_DefMemoryTableHandle(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.EepResTablesTblPtr == NULL,
    ...
    UtAssert_True(
        ...
        "strncmp(CS_AppData.ResTablesTblPtr[0].Name, 'CS.DefMemoryTbl', 20) == "
        "0");
...
void CS_ProcessNewTablesDefinitionTable_Test_DefTablesTableHandle(void) {
    ...
    UtAssert_True(
        ...
        "strncmp(CS_AppData.ResTablesTblPtr[0].Name, 'CS.DefTablesTbl', 20) == "
        "0");
...
void CS_ProcessNewTablesDefinitionTable_Test_ResEepromTableHandle(void) {
    ...
    UtAssert_True(
        ...
        "strncmp(CS_AppData.ResTablesTblPtr[0].Name, 'CS.ResEepromTbl', 20) == "
        "0");
...
void CS_ProcessNewTablesDefinitionTable_Test_ResMemoryTableHandle(void) {
    ...
    UtAssert_True(
        ...
        "strncmp(CS_AppData.ResTablesTblPtr[0].Name, 'CS.ResMemoryTbl', 20) == "
        "0");
...
void CS_ProcessNewTablesDefinitionTable_Test_ResTablesTableHandle(void) {
    ...
    UtAssert_True(
        ...
        "strncmp(CS_AppData.ResTablesTblPtr[0].Name, 'CS.ResTablesTbl', 20) == "
        "0");
...
void CS_ProcessNewTablesDefinitionTable_Test_StateEmptyNoValidEntries(void) {
    ...
    UtAssert_True(
        ...
        "CS_AppData.ResTablesTblPtr[0].TblHandle == CFE_TBL_BAD_TABLE_HANDLE");
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].IsCSOwner == FALSE,
                  "CS_AppData.ResTablesTblPtr[0].IsCSOwner == FALSE");
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].Name[0] == '\0',
                  "CS_AppData.ResTablesTblPtr[0].Name[0] == '\0'");

    UtAssert_True(CS_AppData.TablesCSState == 99,
                  "CS_AppData.TablesCSState == 99");

    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_PROCESS_TABLES_NO_ENTRIES_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ProcessNewTablesDefinitionTable_Test_LimitApplicationNameLength(void) {
    ...
    /* String name chosen to be of length OS_MAX_API_NAME in order to satisfy
     * condition "AppNameIndex == OS_MAX_API_NAME" */
    /* If intended branch is reached, name length will be truncated to length
     * OS_MAX_API_NAME - 1 */
    for (i = 0; i <= OS_MAX_API_NAME; i++) {
        strncat(CS_AppData.DefTablesTblPtr[0].Name, "x", OS_MAX_API_NAME);
    }

    strncat(CS_AppData.DefTablesTblPtr[0].Name, ".DefEepromTbl",
            OS_MAX_API_NAME);
    ...
    Ut_CFE_ES_SetFunctionHook(UT_CFE_ES_GETAPPNAME_INDEX,
                              &CS_TABLE_PROCESSING_TEST_CFE_ES_GetAppNameHook2);
    ...
    /* Verify results */
    /* Note: This test is a special case where we're only interested in seeing
     * that one branch was taken: "if (AppNameIndex == OS_MAX_API_NAME)" */
    /* If branch was taken, line "CS_AppData.EepResTablesTblPtr = ResultsEntry"
     * will not be reached, and so the following assert will pass */
    UtAssert_True(
        CS_AppData.EepResTablesTblPtr != CS_AppData.ResTablesTblPtr,
        "CS_AppData.EepResTablesTblPtr != CS_AppData.ResTablesTblPtr");
...
void CS_ProcessNewTablesDefinitionTable_Test_LimitTableNameLength(void) {
    ...
    /* String name chosen to be of length CFE_TBL_MAX_NAME_LENGTH in order to
     * satisfy condition "TableNameIndex == CFE_TBL_MAX_NAME_LENGTH" */
    /* If intended branch is reached, name length will be truncated to length
     * CFE_TBL_MAX_NAME_LENGTH - 1 */
    for (i = 0; i <= CFE_TBL_MAX_NAME_LENGTH; i++) {
        strncat(CS_AppData.DefTablesTblPtr[0].Name, "x",
    ...
    /* Verify results */
    /* Note: This test is a special case where we're only interested in seeing
     * that one branch was taken: "if (TableNameIndex ==
     * CFE_TBL_MAX_NAME_LENGTH)" */
    /* If branch was taken, line "CS_AppData.EepResTablesTblPtr = ResultsEntry"
     * will not be reached, and so the following assert will pass */
    UtAssert_True(
...
void CS_ProcessNewAppDefinitionTable_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.ResAppTblPtr[0].State == 88,
                  "CS_AppData.ResAppTblPtr[0].State == 88");
    UtAssert_True(CS_AppData.ResAppTblPtr[0].ComputedYet == FALSE,
                  "CS_AppData.ResAppTblPtr[0].ComputedYet == FALSE");
    UtAssert_True(CS_AppData.ResAppTblPtr[0].NumBytesToChecksum == 0,
                  "CS_AppData.ResAppTblPtr[0].NumBytesToChecksum == 0");
    UtAssert_True(CS_AppData.ResAppTblPtr[0].ComparisonValue == 0,
                  "CS_AppData.ResAppTblPtr[0].ComparisonValue == 0");
    UtAssert_True(CS_AppData.ResAppTblPtr[0].ByteOffset == 0,
                  "CS_AppData.ResAppTblPtr[0].ByteOffset == 0");
    UtAssert_True(CS_AppData.ResAppTblPtr[0].TempChecksumValue == 0,
                  "CS_AppData.ResAppTblPtr[0].TempChecksumValue == 0");
    UtAssert_True(CS_AppData.ResAppTblPtr[0].StartAddress == 0,
                  "CS_AppData.ResAppTblPtr[0].StartAddress == 0");
...
void CS_ProcessNewAppDefinitionTable_Test_StateEmptyNoValidEntries(void) {
    ...
    UtAssert_True(CS_AppData.ResAppTblPtr[0].StartAddress == 0,
                  "CS_AppData.ResAppTblPtr[0].StartAddress == 0");
    UtAssert_True(CS_AppData.ResAppTblPtr[0].Name[0] == '\0',
                  "CS_AppData.ResAppTblPtr[0].Name[0] == '\0'");

    UtAssert_True(CS_AppData.AppCSState == 99, "CS_AppData.AppCSState == 99");

    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_PROCESS_APP_NO_ENTRIES_INF_EID, CFE_EVS_INFORMATION,
...
void CS_TableInit_Test_DefaultDefinitionTableLoadErrorEEPROM(void) {
    ...
    /* Note: first 2 arguments are passed in as addresses of pointers in the
       ...
       just pointers */
    Result = CS_TableInit(
        &DefinitionTableHandle, &ResultsTableHandle,
        &CS_AppData.DefEepromTblPtr, &CS_AppData.ResEepromTblPtr,
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_TBL_INIT_ERR_EID, CFE_EVS_ERROR,
                             "CS received error 0xFFFFFFFF initializing "
                             "Definition table for Eeprom"),
        "CS received error 0xFFFFFFFF initializing Definition table for "
        "Eeprom");
...
void CS_TableInit_Test_DefinitionTableGetAddressErrorEEPROM(void) {
    ...
    /* Set to fail condition "Result >= CFE_SUCCESS" after 2nd call to
     * GetAddress */
...
void CS_TableInit_Test_DefinitionTableGetAddressErrorMemory(void) {
    ...
    Result = CS_TableInit(
        &DefinitionTableHandle, &ResultsTableHandle,
        &CS_AppData.DefMemoryTblPtr, &CS_AppData.ResMemoryTblPtr,
...
void CS_TableInit_Test_DefinitionTableGetAddressErrorTables(void) {
    ...
    Result = CS_TableInit(
        &DefinitionTableHandle, &ResultsTableHandle,
        &CS_AppData.DefTablesTblPtr, &CS_AppData.ResTablesTblPtr,
...
void CS_TableInit_Test_DefinitionTableGetAddressErrorApps(void) {
    ...
    /* Note: first 2 arguments are passed in as addresses of pointers in the
       ...
       just pointers */
    Result = CS_TableInit(
        &DefinitionTableHandle, &ResultsTableHandle, &CS_AppData.DefAppTblPtr,
        &CS_AppData.ResAppTblPtr, CS_APP_TABLE, CS_DEF_APP_TABLE_NAME,
        CS_RESULTS_APP_TABLE_NAME, CS_MAX_NUM_APP_TABLE_ENTRIES,
        CS_DEF_APP_TABLE_FILENAME, &CS_AppData.DefaultAppDefTable,
        sizeof(CS_Def_App_Table_Entry_t), sizeof(CS_Res_App_Table_Entry_t),
        NULL);
...
void CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterResultsTableRegisterError(
    void) {
    int32 Result;
    CFE_TBL_Handle_t DefinitionTableHandle = 0;
    CFE_TBL_Handle_t ResultsTableHandle    = 0;
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.EepromCSState == CS_STATE_DISABLED,
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 0,
     ...
     CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterResultsTableRegisterError
   */

void CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterResultsTableGetAddressError(
    void) {
    int32 Result;
    CFE_TBL_Handle_t DefinitionTableHandle = 0;
    CFE_TBL_Handle_t ResultsTableHandle    = 0;
    ...
    /* On 1st call, return -1 to set LoadedFromMemory.  On 2nd call, return
     * CFE_SUCCESS to prevent error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, -1, 1);
    Ut_CFE_TBL_SetFunctionHook(
        UT_CFE_TBL_GETADDRESS_INDEX,
        &CS_TABLE_PROCESSING_TEST_CFE_TBL_GetAddressHook);
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 0,
     ...
     CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterResultsTableGetAddressError
   */

void CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterDefinitionTableRegisterError(
    void) {
    int32 Result;
    CFE_TBL_Handle_t DefinitionTableHandle = 0;
    CFE_TBL_Handle_t ResultsTableHandle    = 0;

    /* Set to satisfy condition "ResultFromLoad != CFE_SUCCESS" on 2nd call to
     * TBL_Register */
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 0,
     ...
     CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterDefinitionTableRegisterError
   */

void CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterDefinitionTableFileLoadError(
    void) {
    int32 Result;
    CFE_TBL_Handle_t DefinitionTableHandle = 0;
    CFE_TBL_Handle_t ResultsTableHandle    = 0;

    /* On 1st call, return -1 to satisfy condition "ResultFromLoad !=
     * CFE_SUCCESS".  On 2nd call, return CFE_SUCCESS to prevent error */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_LOAD_INDEX, -1, 1);
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_LOAD_INDEX,
                               &CS_TABLE_PROCESSING_TEST_CFE_TBL_LoadHook);
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 0,
     ...
     CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterDefinitionTableFileLoadError
   */
...
void CS_TableInit_Test_MemoryTableAndLoadedFromMemory(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.MemoryCSState == CS_STATE_DISABLED,
...
void CS_TableInit_Test_AppTableAndLoadedFromMemory(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.AppCSState == CS_STATE_DISABLED,
...
void CS_TableInit_Test_TablesTableAndLoadedFromMemory(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.TablesCSState == CS_STATE_DISABLED,
...
void CS_HandleTableUpdate_Test_ProcessNewTablesDefinitionTable(void) {
    ...
    /* On 1st call, return CFE_SUCCESS to prevent error.  On 2nd call, return
     * UT_CFE_TBL_GETADDRESS_INDEX to satisfy condition "Result ==
    ...
    /* Note: first 2 arguments are passed in as addresses of pointers in the
       ...
       pointers and the variable names of the arguments suggest that they're
       just pointers */
    Result = CS_HandleTableUpdate(&CS_AppData.DefTablesTblPtr,
                                  &CS_AppData.ResTablesTblPtr,
                                  DefinitionTableHandle, ResultsTableHandle,
                                  Table, CS_MAX_NUM_TABLES_TABLE_ENTRIES);
...
void CS_HandleTableUpdate_Test_ProcessNewAppDefinitionTable(void) {
    ...
    Result = CS_HandleTableUpdate(
        &CS_AppData.DefAppTblPtr, &CS_AppData.ResAppTblPtr,
        DefinitionTableHandle, ResultsTableHandle, Table, NumEntries);
...
void CS_HandleTableUpdate_Test_ResultsTableGetAddressErrorEEPROM(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_TBL_UPDATE_ERR_EID, CFE_EVS_ERROR,
                      "CS had problems updating table. Release:0x00000000 "
                      "Manage:0x00000000 Get:0x00000000 for table Eeprom"),
                  "CS had problems updating table. Release:0x00000000 "
                  "Manage:0x00000000 Get:0x00000000 for table Eeprom");
...
void CS_HandleTableUpdate_Test_DefinitionTableGetAddressErrorEEPROM(void) {
    ...
    /* Set to generate error message CS_TBL_UPDATE_ERR_EID.  Also prevent issues
     * by returning CFE_SUCCESS on all calls except the 2nd. */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, -1, 2);
    Ut_CFE_TBL_SetFunctionHook(
        UT_CFE_TBL_GETADDRESS_INDEX,
        &CS_TABLE_PROCESSING_TEST_CFE_TBL_GetAddressHook);
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_TBL_UPDATE_ERR_EID, CFE_EVS_ERROR,
                      "CS had problems updating table. Release:0x00000000 "
                      "Manage:0x00000000 Get:0xFFFFFFFF for table Eeprom"),
                  "CS had problems updating table. Release:0x00000000 "
                  "Manage:0x00000000 Get:0xFFFFFFFF for table Eeprom");
...
void CS_HandleTableUpdate_Test_DefinitionTableGetAddressErrorMemory(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_TBL_UPDATE_ERR_EID, CFE_EVS_ERROR,
                      "CS had problems updating table. Release:0x00000000 "
                      "Manage:0x00000000 Get:0xFFFFFFFF for table Memory"),
                  "CS had problems updating table. Release:0x00000000 "
                  "Manage:0x00000000 Get:0xFFFFFFFF for table Memory");
...
void CS_HandleTableUpdate_Test_DefinitionTableGetAddressErrorTables(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_TBL_UPDATE_ERR_EID, CFE_EVS_ERROR,
                      "CS had problems updating table. Release:0x00000000 "
                      "Manage:0x00000000 Get:0xFFFFFFFF for table Table"),
                  "CS had problems updating table. Release:0x00000000 "
                  "Manage:0x00000000 Get:0xFFFFFFFF for table Table");
...
void CS_HandleTableUpdate_Test_DefinitionTableGetAddressErrorApps(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_TBL_UPDATE_ERR_EID, CFE_EVS_ERROR,
                      "CS had problems updating table. Release:0x00000000 "
                      "Manage:0x00000000 Get:0xFFFFFFFF for table App"),
                  "CS had problems updating table. Release:0x00000000 "
                  "Manage:0x00000000 Get:0xFFFFFFFF for table App");
...
void CS_Table_Processing_Test_AddTestCases(void) {
    UtTest_Add(CS_ValidateEepromChecksumDefinitionTable_Test_Nominal,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ValidateEepromChecksumDefinitionTable_Test_Nominal");
    UtTest_Add(
        CS_ValidateEepromChecksumDefinitionTable_Test_IllegalChecksumRangeStateEnabled,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateEepromChecksumDefinitionTable_Test_"
        "IllegalChecksumRangeStateEnabled");
    UtTest_Add(
        CS_ValidateEepromChecksumDefinitionTable_Test_IllegalChecksumRangeStateDisabled,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateEepromChecksumDefinitionTable_Test_"
        "IllegalChecksumRangeStateDisabled");
    UtTest_Add(
        CS_ValidateEepromChecksumDefinitionTable_Test_IllegalStateField,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateEepromChecksumDefinitionTable_Test_IllegalStateField");

    UtTest_Add(CS_ValidateMemoryChecksumDefinitionTable_Test_Nominal,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ValidateMemoryChecksumDefinitionTable_Test_Nominal");
    UtTest_Add(
        CS_ValidateMemoryChecksumDefinitionTable_Test_IllegalChecksumRangeStateEnabled,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateMemoryChecksumDefinitionTable_Test_"
        "IllegalChecksumRangeStateEnabled");
    UtTest_Add(
        CS_ValidateMemoryChecksumDefinitionTable_Test_IllegalChecksumRangeStateDisabled,
        CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(CS_ValidateTablesChecksumDefinitionTable_Test_Nominal,
               CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateTablesChecksumDefinitionTable_Test_"
        "DuplicateNameStateEmpty");
    UtTest_Add(
        CS_ValidateTablesChecksumDefinitionTable_Test_DuplicateNameStateEnabled,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateTablesChecksumDefinitionTable_Test_"
        "DuplicateNameStateEnabled");
    UtTest_Add(
        CS_ValidateTablesChecksumDefinitionTable_Test_DuplicateNameStateDisabled,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateTablesChecksumDefinitionTable_Test_"
        "DuplicateNameStateDisabled");
    UtTest_Add(
    ...
    UtTest_Add(CS_ValidateAppChecksumDefinitionTable_Test_Nominal,
               CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ValidateAppChecksumDefinitionTable_Test_"
        "DuplicateNameStateDisabled");
    UtTest_Add(CS_ValidateAppChecksumDefinitionTable_Test_IllegalStateField,
               CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ProcessNewEepromMemoryDefinitionTable_Test_"
        "EEPROMTableNoValidEntries");
    UtTest_Add(
        CS_ProcessNewEepromMemoryDefinitionTable_Test_MemoryTableNoValidEntries,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ProcessNewEepromMemoryDefinitionTable_Test_"
        "MemoryTableNoValidEntries");
    ...
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_DefMemoryTableHandle,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewTablesDefinitionTable_Test_DefMemoryTableHandle");
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_DefTablesTableHandle,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewTablesDefinitionTable_Test_DefTablesTableHandle");
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_DefAppTableHandle,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewTablesDefinitionTable_Test_DefAppTableHandle");
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_ResEepromTableHandle,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewTablesDefinitionTable_Test_ResEepromTableHandle");
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_ResMemoryTableHandle,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewTablesDefinitionTable_Test_ResMemoryTableHandle");
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_ResTablesTableHandle,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewTablesDefinitionTable_Test_ResTablesTableHandle");
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_ResAppTableHandle,
               CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ProcessNewTablesDefinitionTable_Test_LimitApplicationNameLength");
    UtTest_Add(CS_ProcessNewTablesDefinitionTable_Test_LimitTableNameLength,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewTablesDefinitionTable_Test_LimitTableNameLength");

    UtTest_Add(CS_ProcessNewAppDefinitionTable_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ProcessNewAppDefinitionTable_Test_Nominal");
    UtTest_Add(CS_ProcessNewAppDefinitionTable_Test_StateEmptyNoValidEntries,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_ProcessNewAppDefinitionTable_Test_StateEmptyNoValidEntries");

    UtTest_Add(CS_TableInit_Test_DefaultDefinitionTableLoadErrorEEPROM,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_TableInit_Test_DefaultDefinitionTableLoadErrorEEPROM");
    UtTest_Add(CS_TableInit_Test_DefinitionTableGetAddressErrorEEPROM,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_TableInit_Test_DefinitionTableGetAddressErrorEEPROM");
    UtTest_Add(CS_TableInit_Test_DefinitionTableGetAddressErrorMemory,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_TableInit_Test_DefinitionTableGetAddressErrorMemory");
    UtTest_Add(CS_TableInit_Test_DefinitionTableGetAddressErrorTables,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_TableInit_Test_DefinitionTableGetAddressErrorTables");
    UtTest_Add(CS_TableInit_Test_DefinitionTableGetAddressErrorApps,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_TableInit_Test_DefinitionTableGetAddressErrorApps");
    UtTest_Add(CS_TableInit_Test_EepromTableAndNotLoadedFromMemory,
               CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_TableInit_Test_"
        "EepromTableAndLoadedFromMemoryAfterResultsTableRegisterError");
    UtTest_Add(
        CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterResultsTableGetAddressError,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_TableInit_Test_"
        "EepromTableAndLoadedFromMemoryAfterResultsTableGetAddressError");
    UtTest_Add(
        CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterDefinitionTableRegisterError,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_TableInit_Test_"
        "EepromTableAndLoadedFromMemoryAfterDefinitionTableRegisterError");
    UtTest_Add(
        CS_TableInit_Test_EepromTableAndLoadedFromMemoryAfterDefinitionTableFileLoadError,
        CS_Test_Setup, CS_Test_TearDown,
        "CS_TableInit_Test_"
        "EepromTableAndLoadedFromMemoryAfterDefinitionTableFileLoadError");
    UtTest_Add(CS_TableInit_Test_MemoryTableAndNotLoadedFromMemory,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_TableInit_Test_MemoryTableAndNotLoadedFromMemory");
    UtTest_Add(CS_TableInit_Test_MemoryTableAndLoadedFromMemory, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_TableInit_Test_MemoryTableAndLoadedFromMemory");
    UtTest_Add(CS_TableInit_Test_AppTableAndNotLoadedFromMemory, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_TableInit_Test_AppTableAndNotLoadedFromMemory");
    UtTest_Add(CS_TableInit_Test_AppTableAndLoadedFromMemory, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_TableInit_Test_AppTableAndLoadedFromMemory");
    UtTest_Add(CS_TableInit_Test_TablesTableAndNotLoadedFromMemory,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_TableInit_Test_TablesTableAndNotLoadedFromMemory");
    UtTest_Add(CS_TableInit_Test_TablesTableAndLoadedFromMemory, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_TableInit_Test_TablesTableAndLoadedFromMemory");

    UtTest_Add(CS_HandleTableUpdate_Test_ProcessNewTablesDefinitionTable,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_HandleTableUpdate_Test_ProcessNewTablesDefinitionTable");
    UtTest_Add(CS_HandleTableUpdate_Test_ProcessNewAppDefinitionTable,
               CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_HandleTableUpdate_Test_ProcessNewEepromMemoryDefinitionTable");
    UtTest_Add(CS_HandleTableUpdate_Test_ResultsTableGetAddressErrorEEPROM,
               CS_Test_Setup, CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_HandleTableUpdate_Test_DefinitionTableGetAddressErrorTables");
    UtTest_Add(CS_HandleTableUpdate_Test_DefinitionTableGetAddressErrorApps,
               CS_Test_Setup, CS_Test_TearDown,
