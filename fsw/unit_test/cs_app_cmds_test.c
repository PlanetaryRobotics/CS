...
void CS_DisableAppCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_APP_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableAppCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_APP_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineAppCmd_Test_Baseline(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_BASELINE_APP_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineAppCmd_Test_NoBaseline(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_NO_BASELINE_APP_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineAppCmd_Test_BaselineInvalidName(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_BASELINE_INVALID_NAME_APP_ERR_EID, CFE_EVS_ERROR,
...
void CS_RecomputeBaselineAppCmd_Test_Nominal(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_APP_STARTED_DBG_EID, CFE_EVS_DEBUG,
...
void CS_RecomputeBaselineAppCmd_Test_CreateChildTaskError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_APP_CREATE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                      "Recompute baseline of app App1 failed, "
...
void CS_RecomputeBaselineAppCmd_Test_UnknownNameError(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_UNKNOWN_NAME_APP_ERR_EID, CFE_EVS_ERROR,
...
void CS_RecomputeBaselineAppCmd_Test_RecomputeInProgress(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_RECOMPUTE_APP_CHDTASK_ERR_EID, CFE_EVS_ERROR,
...
void CS_DisableNameAppCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_APP_NAME_INF_EID, CFE_EVS_INFORMATION,
...
void CS_DisableNameAppCmd_Test_UpdateAppsDefinitionTableError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_DISABLE_APP_DEF_NOT_FOUND_DBG_EID, CFE_EVS_DEBUG,
...
void CS_DisableNameAppCmd_Test_UnknownNameError(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_DISABLE_APP_UNKNOWN_NAME_ERR_EID, CFE_EVS_ERROR,
...
void CS_EnableNameAppCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_APP_NAME_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableNameAppCmd_Test_UpdateAppsDefinitionTableError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_ENABLE_APP_DEF_NOT_FOUND_DBG_EID, CFE_EVS_DEBUG,
            "CS unable to update apps definition table for entry App1"),
        "CS unable to update apps definition table for entry App1");
...
void CS_EnableNameAppCmd_Test_UnknownNameError(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_ENABLE_APP_UNKNOWN_NAME_ERR_EID, CFE_EVS_ERROR,
...
void CS_App_Cmds_Test_AddTestCases(void) {
    UtTest_Add(CS_DisableAppCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_DisableAppCmd_Test");

    UtTest_Add(CS_EnableAppCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_EnableAppCmd_Test");

    UtTest_Add(CS_ReportBaselineAppCmd_Test_Baseline, CS_Test_Setup,
               CS_Test_TearDown, "CS_ReportBaselineAppCmd_Test_Baseline");
    UtTest_Add(CS_ReportBaselineAppCmd_Test_NoBaseline, CS_Test_Setup,
               CS_Test_TearDown, "CS_ReportBaselineAppCmd_Test_NoBaseline");
    UtTest_Add(CS_ReportBaselineAppCmd_Test_BaselineInvalidName, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ReportBaselineAppCmd_Test_BaselineInvalidName");

    UtTest_Add(CS_RecomputeBaselineAppCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeBaselineAppCmd_Test_Nominal");
    ...
    UtTest_Add(CS_RecomputeBaselineAppCmd_Test_UnknownNameError, CS_Test_Setup,
               CS_Test_TearDown,
    ...
    UtTest_Add(CS_DisableNameAppCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_DisableNameAppCmd_Test_Nominal");
    ...
    UtTest_Add(CS_DisableNameAppCmd_Test_UnknownNameError, CS_Test_Setup,
               CS_Test_TearDown, "CS_DisableNameAppCmd_Test_UnknownNameError");

    UtTest_Add(CS_EnableNameAppCmd_Test_Nominal, CS_Test_Setup,
    ...
    UtTest_Add(CS_EnableNameAppCmd_Test_UnknownNameError, CS_Test_Setup,
               CS_Test_TearDown, "CS_EnableNameAppCmd_Test_UnknownNameError");
