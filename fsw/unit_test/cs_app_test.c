...
int32 CS_APP_TEST_CFE_TBL_LoadHook(CFE_TBL_Handle_t TblHandle,
                                   CFE_TBL_SrcEnum_t SrcType,
                                   const void* SrcDataPtr) {
    return CFE_SUCCESS;
}

uint32 CS_APP_TEST_CFE_ES_RestoreFromCDS_Hook(uint8* DataStoreBuffer,
                                              uint32 DataStoreHandle) {
...
void CS_App_TestCmdTlmAlign(void) {
    /* Ensures the command and telemetry structures are padded to and aligned to
     * 32-bits */
#define CMD_STRUCT_DATA_IS_32_ALIGNED(x) \
    ((sizeof(x) - CFE_SB_CMD_HDR_SIZE) % 4) == 0
#define TLM_STRUCT_DATA_IS_32_ALIGNED(x) \
    ((sizeof(x) - CFE_SB_TLM_HDR_SIZE) % 4) == 0

    UtAssert_True(TLM_STRUCT_DATA_IS_32_ALIGNED(CS_HkPacket_t),
                  "CS_HkPacket_t is 32-bit aligned");

    UtAssert_True(CMD_STRUCT_DATA_IS_32_ALIGNED(CS_NoArgsCmd_t),
                  "CS_NoArgsCmd_t is 32-bit aligned");
    UtAssert_True(CMD_STRUCT_DATA_IS_32_ALIGNED(CS_GetEntryIDCmd_t),
                  "CS_GetEntryIDCmd_t is 32-bit aligned");
    UtAssert_True(CMD_STRUCT_DATA_IS_32_ALIGNED(CS_EntryCmd_t),
                  "CS_EntryCmd_t is 32-bit aligned");
    UtAssert_True(CMD_STRUCT_DATA_IS_32_ALIGNED(CS_TableNameCmd_t),
                  "CS_TableNameCmd_t is 32-bit aligned");
    UtAssert_True(CMD_STRUCT_DATA_IS_32_ALIGNED(CS_AppNameCmd_t),
                  "CS_AppNameCmd_t is 32-bit aligned");
    UtAssert_True(CMD_STRUCT_DATA_IS_32_ALIGNED(CS_OneShotCmd_t),
                  "CS_OneShotCmd_t is 32-bit aligned");
}
...
void CS_AppMain_Test_Nominal(void) {
    ...
    /* 2 Messages Tested elsewhere so we can ignore them here. INFO:CS
     * Initialized  and ERROR:Invalid Command pipe  */
    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 3,
                  "Ut_CFE_EVS_GetEventQueueDepth() == 3");
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_EXIT_INF_EID, CFE_EVS_INFORMATION,
...
void CS_AppMain_Test_RegisterAppError(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.RunStatus == CFE_ES_APP_ERROR,
                  "CS_AppData.RunStatus == CFE_ES_APP_ERROR");

    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_EXIT_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppMain_Test_AppPipeError(void) {
    ...
    Ut_CFE_SB_SetReturnCode(UT_CFE_SB_GETTOTALMSGLENGTH_INDEX,
                            sizeof(CS_NoArgsCmd_t), 1);
...
void CS_AppInit_Test_Nominal(void) {
    ...
    /* Verify results */
    sprintf(Message, "CS Initialized. Version %d.%d.%d.%d", CS_MAJOR_VERSION,
            CS_MINOR_VERSION, CS_REVISION, CS_MISSION_REV);
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_INIT_INF_EID, CFE_EVS_INFORMATION, Message),
        Message);
...
void CS_AppInit_Test_NominalPowerOnReset(void) {
    ...
    Ut_CFE_ES_SetReturnCode(UT_CFE_ES_GETRESETTYPE_INDEX, CFE_ES_POWERON_RESET,
                            1);
    ...
    UtAssert_True(CS_AppData.EepromCSState == CS_EEPROM_TBL_POWERON_STATE,
                  "CS_AppData.EepromCSState == CS_EEPROM_TBL_POWERON_STATE");
    UtAssert_True(CS_AppData.MemoryCSState == CS_MEMORY_TBL_POWERON_STATE,
                  "CS_AppData.MemoryCSState == CS_MEMORY_TBL_POWERON_STATE");
    UtAssert_True(CS_AppData.AppCSState == CS_APPS_TBL_POWERON_STATE,
                  "CS_AppData.AppCSState    == CS_APPS_TBL_POWERON_STATE");
    UtAssert_True(CS_AppData.TablesCSState == CS_TABLES_TBL_POWERON_STATE,
                  "CS_AppData.TablesCSState == CS_TABLES_TBL_POWERON_STATE");

    UtAssert_True(CS_AppData.OSCSState == CS_OSCS_CHECKSUM_STATE,
                  "CS_AppData.OSCSState == CS_OSCS_CHECKSUM_STATE");
    UtAssert_True(CS_AppData.CfeCoreCSState == CS_CFECORE_CHECKSUM_STATE,
...
void CS_AppInit_Test_NominalProcReset(void) {
    ...
    Ut_CFE_ES_SetReturnCode(UT_CFE_ES_GETRESETTYPE_INDEX,
                            CFE_ES_PROCESSOR_RESET, 2);
    Ut_CFE_ES_SetFunctionHook(UT_CFE_ES_RESTOREFROMCDS_INDEX,
    ...
    UtAssert_True(CS_AppData.EepromCSState == CS_STATE_ENABLED,
                  "CS_AppData.EepromCSState == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.MemoryCSState == CS_STATE_ENABLED,
                  "CS_AppData.MemoryCSState == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.AppCSState == CS_STATE_ENABLED,
                  "CS_AppData.AppCSState    == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.TablesCSState == CS_STATE_ENABLED,
                  "CS_AppData.TablesCSState == CS_STATE_ENABLED");

    UtAssert_True(CS_AppData.OSCSState == CS_STATE_ENABLED,
                  "CS_AppData.OSCSState == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.CfeCoreCSState == CS_STATE_ENABLED,
...
void CS_CreateRestoreStatesFromCDS_Test_NoExistingCDS(void) {
    ...
    UtAssert_True(CS_AppData.MemoryCSState == 99,
                  "CS_AppData.MemoryCSState == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.AppCSState == 99,
                  "CS_AppData.AppCSState  == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.TablesCSState == 99,
                  "CS_AppData.TablesCSState == CS_STATE_ENABLED");

    UtAssert_True(CS_AppData.OSCSState == 99,
                  "CS_AppData.OSCSState == CS_OSCS_CHECKSUM_STATE");
    UtAssert_True(CS_AppData.CfeCoreCSState == 99,
                  "CS_AppData.CfeCoreCSState == CS_CFECORE_CHECKSUM_STATE");
...
void CS_CreateRestoreStatesFromCDS_Test_CDSFail(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_INIT_CDS_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppInit_Test_EVSRegisterError(void) {
    ...
    /* Set CFE_EVS_Register to return -1 in order to reach call to
...
void CS_AppInit_Test_SBSubscribeHKError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_INIT_SB_SUBSCRIBE_HK_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppInit_Test_SBSubscribeBackgroundCycleError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_INIT_SB_SUBSCRIBE_BACK_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppInit_Test_TableInitErrorEEPROM(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_INIT_EEPROM_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppInit_Test_TableInitErrorMemory(void) {
    ...
    /* Set to generate error message CS_INIT_SB_CREATE_ERR_EID.
     * Combining a SetReturnCode and a SetFunctionHook in order to return
     * CFE_SUCCESS all runs except the one specified */
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_LOAD_INDEX, -1, 2);
    Ut_CFE_TBL_ContinueReturnCodeAfterCountZero(UT_CFE_TBL_LOAD_INDEX);
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_LOAD_INDEX,
                               CS_APP_TEST_CFE_TBL_LoadHook);
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_INIT_MEMORY_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppInit_Test_TableInitErrorApps(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_INIT_APP_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppInit_Test_TableInitErrorTables(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_INIT_TABLES_ERR_EID, CFE_EVS_ERROR,
...
void CS_AppInit_Test_TextSegmentInfoError(void) {
    ...
    Ut_CFE_PSP_MEMORY_SetReturnCode(
        UT_CFE_PSP_MEMORY_GETKERNELTEXTSEGMENTINFO_INDEX, -1, 1);
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_OS_TEXT_SEG_INF_EID, CFE_EVS_INFORMATION,
...
void CS_AppPipe_Test_TableUpdateErrors(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_UPDATE_EEPROM_ERR_EID, CFE_EVS_ERROR,
                             "Table update failed for Eeprom: 0xCC000001, "
                             "checksumming Eeprom is disabled"),
        "Table update failed for Eeprom: 0xCC000001, checksumming Eeprom is "
        "disabled");
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_UPDATE_MEMORY_ERR_EID, CFE_EVS_ERROR,
                             "Table update failed for Memory: 0xCC000001, "
                             "checksumming Memory is disabled"),
        "Table update failed for Memory: 0xCC000001, checksumming Memory is "
        "disabled");
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_UPDATE_APP_ERR_EID, CFE_EVS_ERROR,
                             "Table update failed for Apps: 0xCC000001, "
                             "checksumming Apps is disabled"),
        "Table update failed for Apps: 0xCC000001, checksumming Apps is "
        "disabled");
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_UPDATE_TABLES_ERR_EID, CFE_EVS_ERROR,
                             "Table update failed for Tables: 0xCC000001, "
                             "checksumming Tables is disabled"),
        "Table update failed for Tables: 0xCC000001, checksumming Tables is "
        "disabled");

    UtAssert_True(CS_AppData.TablesCSState == CS_STATE_DISABLED,
                  "CS_AppData.TablesCSState == CS_STATE_DISABLED");

    UtAssert_True(Ut_CFE_EVS_GetEventQueueDepth() == 9,
                  "Ut_CFE_EVS_GetEventQueueDepth() == 9");
...
void CS_AppPipe_Test_BackgroundCycle(void) {
    ...
    CFE_SB_InitMsg(&CmdPacket, CS_BACKGROUND_CYCLE_MID, sizeof(CS_NoArgsCmd_t),
                   TRUE);
...
void CS_AppPipe_Test_InvalidMIDError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_MID_ERR_EID, CFE_EVS_ERROR,
...
void CS_HousekeepingCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.HkPacket.CmdCounter == 1,
                  "CS_AppData.HkPacket.CmdCounter == 1");
    UtAssert_True(CS_AppData.HkPacket.CmdErrCounter == 2,
                  "CS_AppData.HkPacket.CmdErrCounter == 2");
    UtAssert_True(CS_AppData.HkPacket.ChecksumState == 3,
                  "CS_AppData.HkPacket.ChecksumState == 3");
    UtAssert_True(CS_AppData.HkPacket.EepromCSState == 4,
                  "CS_AppData.HkPacket.EepromCSState == 4");
    UtAssert_True(CS_AppData.HkPacket.MemoryCSState == 5,
                  "CS_AppData.HkPacket.MemoryCSState == 5");
    UtAssert_True(CS_AppData.HkPacket.AppCSState == 6,
                  "CS_AppData.HkPacket.AppCSState == 6");
    UtAssert_True(CS_AppData.HkPacket.TablesCSState == 7,
                  "CS_AppData.HkPacket.TablesCSState == 7");
    UtAssert_True(CS_AppData.HkPacket.OSCSState == 8,
                  "CS_AppData.HkPacket.OSCSState == 8");
    UtAssert_True(CS_AppData.HkPacket.CfeCoreCSState == 9,
                  "CS_AppData.HkPacket.CfeCoreCSState == 9");
    UtAssert_True(CS_AppData.HkPacket.RecomputeInProgress == 10,
                  "CS_AppData.HkPacket.ChildTaskInUse == 10");
    UtAssert_True(CS_AppData.HkPacket.OneShotInProgress == 11,
                  "CS_AppData.HkPacket.OneShotInProgress == 11");
    UtAssert_True(CS_AppData.HkPacket.EepromCSErrCounter == 12,
                  "CS_AppData.HkPacket.EepromCSErrCounter == 12");
    UtAssert_True(CS_AppData.HkPacket.MemoryCSErrCounter == 13,
                  "CS_AppData.HkPacket.MemoryCSErrCounter == 13");
    UtAssert_True(CS_AppData.HkPacket.AppCSErrCounter == 14,
                  "CS_AppData.HkPacket.AppCSErrCounter == 14");
    UtAssert_True(CS_AppData.HkPacket.TablesCSErrCounter == 15,
                  "CS_AppData.HkPacket.TablesCSErrCounter == 15");
    UtAssert_True(CS_AppData.HkPacket.CfeCoreCSErrCounter == 16,
                  "CS_AppData.HkPacket.CfeCoreCSErrCounter == 16");
    UtAssert_True(CS_AppData.HkPacket.OSCSErrCounter == 17,
                  "CS_AppData.HkPacket.OSCSErrCounter == 17");
    UtAssert_True(CS_AppData.HkPacket.CurrentCSTable == 18,
                  "CS_AppData.HkPacket.CurrentCSTable == 18");
    UtAssert_True(CS_AppData.HkPacket.CurrentEntryInTable == 19,
                  "CS_AppData.HkPacket.CurrentEntryInTable == 19");
    UtAssert_True(CS_AppData.HkPacket.EepromBaseline == 20,
                  "CS_AppData.HkPacket.EepromBaseline == 20");
    UtAssert_True(CS_AppData.HkPacket.OSBaseline == 21,
                  "CS_AppData.HkPacket.OSBaseline == 21");
    UtAssert_True(CS_AppData.HkPacket.CfeCoreBaseline == 22,
                  "CS_AppData.HkPacket.CfeCoreBaseline == 22");
    UtAssert_True(CS_AppData.HkPacket.LastOneShotAddress == 23,
                  "CS_AppData.HkPacket.LastOneShotAddress == 23");
    UtAssert_True(CS_AppData.HkPacket.LastOneShotSize == 24,
                  "CS_AppData.HkPacket.LastOneShotSize == 24");
    UtAssert_True(CS_AppData.HkPacket.LastOneShotChecksum == 25,
                  "CS_AppData.HkPacket.LastOneShotChecksum == 25");
    UtAssert_True(CS_AppData.HkPacket.PassCounter == 26,
...
void CS_App_Test_AddTestCases(void) {
    UtTest_Add(CS_App_TestCmdTlmAlign, CS_Test_Setup, CS_Test_TearDown,
               "CS_App_TestCmdTlmAlign");

    UtTest_Add(CS_AppMain_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppMain_Test_Nominal");
    UtTest_Add(CS_AppMain_Test_RegisterAppError, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppMain_Test_RegisterAppError");
    UtTest_Add(CS_AppMain_Test_AppInitError, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppMain_Test_AppInitError");
    UtTest_Add(CS_AppMain_Test_RcvMsgError, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppMain_Test_RcvMsgError");
    UtTest_Add(CS_AppMain_Test_AppPipeError, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppMain_Test_AppPipeError");

    UtTest_Add(CS_AppInit_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppInit_Test_Nominal");
    UtTest_Add(CS_AppInit_Test_EVSRegisterError, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_EVSRegisterError");
    UtTest_Add(CS_AppInit_Test_SBCreatePipeError, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_SBCreatePipeError");
    UtTest_Add(CS_AppInit_Test_SBSubscribeHKError, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_SBSubscribeHKError");
    UtTest_Add(CS_AppInit_Test_SBSubscribeBackgroundCycleError, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_AppInit_Test_SBSubscribeBackgroundCycleError");
    UtTest_Add(CS_AppInit_Test_SBSubscribeCmdError, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_SBSubscribeCmdError");
    UtTest_Add(CS_AppInit_Test_TableInitErrorEEPROM, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_TableInitErrorEEPROM");
    UtTest_Add(CS_AppInit_Test_TableInitErrorMemory, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_TableInitErrorMemory");
    UtTest_Add(CS_AppInit_Test_TableInitErrorApps, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_TableInitErrorApps");
    UtTest_Add(CS_AppInit_Test_TableInitErrorTables, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_TableInitErrorTables");
    UtTest_Add(CS_AppInit_Test_TextSegmentInfoError, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_TextSegmentInfoError");

    UtTest_Add(CS_AppPipe_Test_TableUpdateErrors, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_TableUpdateErrors");
    UtTest_Add(CS_AppPipe_Test_BackgroundCycle, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_BackgroundCycle");
    UtTest_Add(CS_AppPipe_Test_NoopCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_NoopCmd");
    UtTest_Add(CS_AppPipe_Test_ResetCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_ResetCmd");
    UtTest_Add(CS_AppPipe_Test_OneShotCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_OneShotCmd");
    UtTest_Add(CS_AppPipe_Test_CancelOneShotCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_CancelOneShotCmd");
    UtTest_Add(CS_AppPipe_Test_EnableAllCSCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_EnableAllCSCmd");
    UtTest_Add(CS_AppPipe_Test_DisableAllCSCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_DisableAllCSCmd");
    UtTest_Add(CS_AppPipe_Test_EnableCfeCoreCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_EnableCfeCoreCmd");
    UtTest_Add(CS_AppPipe_Test_DisableCfeCoreCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableCfeCoreCmd");
    UtTest_Add(CS_AppPipe_Test_ReportBaselineCfeCoreCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_ReportBaselineCfeCoreCmd");
    UtTest_Add(CS_AppPipe_Test_RecomputeBaselineCfeCoreCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_RecomputeBaselineCfeCoreCmd");
    UtTest_Add(CS_AppPipe_Test_EnableOSCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_EnableOSCmd");
    UtTest_Add(CS_AppPipe_Test_DisableOSCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_DisableOSCmd");
    UtTest_Add(CS_AppPipe_Test_ReportBaselineOSCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_ReportBaselineOSCmd");
    UtTest_Add(CS_AppPipe_Test_RecomputeBaselineOSCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_RecomputeBaselineOSCmd");
    UtTest_Add(CS_AppPipe_Test_EnableEepromCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_EnableEepromCmd");
    UtTest_Add(CS_AppPipe_Test_DisableEepromCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableEepromCmd");
    UtTest_Add(CS_AppPipe_Test_ReportBaselineEntryIDEepromCmd, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_AppPipe_Test_ReportBaselineEntryIDEepromCmd");
    UtTest_Add(CS_AppPipe_Test_RecomputeBaselineEepromCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_RecomputeBaselineEepromCmd");
    UtTest_Add(CS_AppPipe_Test_EnableEntryIDEepromCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_EnableEntryIDEepromCmd");
    UtTest_Add(CS_AppPipe_Test_DisableEntryIDEepromCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableEntryIDEepromCmd");
    UtTest_Add(CS_AppPipe_Test_GetEntryIDEepromCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_GetEntryIDEepromCmd");
    UtTest_Add(CS_AppPipe_Test_EnableMemoryCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_EnableMemoryCmd");
    UtTest_Add(CS_AppPipe_Test_DisableMemoryCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableMemoryCmd");
    UtTest_Add(CS_AppPipe_Test_ReportBaselineEntryIDMemoryCmd, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_AppPipe_Test_ReportBaselineEntryIDMemoryCmd");
    UtTest_Add(CS_AppPipe_Test_RecomputeBaselineMemoryCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_RecomputeBaselineMemoryCmd");
    UtTest_Add(CS_AppPipe_Test_EnableEntryIDMemoryCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_EnableEntryIDMemoryCmd");
    UtTest_Add(CS_AppPipe_Test_DisableEntryIDMemoryCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableEntryIDMemoryCmd");
    UtTest_Add(CS_AppPipe_Test_GetEntryIDMemoryCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_GetEntryIDMemoryCmd");
    UtTest_Add(CS_AppPipe_Test_EnableTablesCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_EnableTablesCmd");
    UtTest_Add(CS_AppPipe_Test_DisableTablesCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableTablesCmd");
    UtTest_Add(CS_AppPipe_Test_ReportBaselineTablesCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_ReportBaselineTablesCmd");
    UtTest_Add(CS_AppPipe_Test_RecomputeBaselineTablesCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_RecomputeBaselineTablesCmd");
    UtTest_Add(CS_AppPipe_Test_EnableNameTablesCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_EnableNameTablesCmd");
    UtTest_Add(CS_AppPipe_Test_DisableNameTablesCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableNameTablesCmd");
    UtTest_Add(CS_AppPipe_Test_EnableAppCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_EnableAppCmd");
    UtTest_Add(CS_AppPipe_Test_DisableAppCmd, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_DisableAppCmd");
    UtTest_Add(CS_AppPipe_Test_ReportBaselineAppCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_ReportBaselineAppCmd");
    UtTest_Add(CS_AppPipe_Test_RecomputeBaselineAppCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_RecomputeBaselineAppCmd");
    UtTest_Add(CS_AppPipe_Test_EnableNameAppCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_EnableNameAppCmd");
    UtTest_Add(CS_AppPipe_Test_DisableNameAppCmd, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppPipe_Test_DisableNameAppCmd");
    UtTest_Add(CS_AppPipe_Test_InvalidCCError, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_InvalidCCError");
    UtTest_Add(CS_AppPipe_Test_InvalidMIDError, CS_Test_Setup, CS_Test_TearDown,
               "CS_AppPipe_Test_InvalidMIDError");

    UtTest_Add(CS_HousekeepingCmd_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_HousekeepingCmd_Test_Nominal");
    UtTest_Add(CS_HousekeepingCmd_Test_InvalidMsgLength, CS_Test_Setup,
               CS_Test_TearDown, "CS_HousekeepingCmd_Test_InvalidMsgLength");

    UtTest_Add(CS_AppInit_Test_NominalPowerOnReset, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_NominalPowerOnReset");
#if (CS_PRESERVE_STATES_ON_PROCESSOR_RESET == TRUE)
    UtTest_Add(CS_AppInit_Test_NominalProcReset, CS_Test_Setup,
               CS_Test_TearDown, "CS_AppInit_Test_NominalProcReset");
    UtTest_Add(CS_CreateRestoreStatesFromCDS_Test_NoExistingCDS, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_CreateRestoreStatesFromCDS_Test_NoExistingCDS");
    UtTest_Add(CS_CreateRestoreStatesFromCDS_Test_CDSSuccess, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_CreateRestoreStatesFromCDS_Test_CDSSuccess");
    UtTest_Add(CS_CreateRestoreStatesFromCDS_Test_CDSFail, CS_Test_Setup,
               CS_Test_TearDown, "CS_CreateRestoreStatesFromCDS_Test_CDSFail");

    UtTest_Add(CS_UpdateCDS_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_UpdateCDS_Test_Nominal");
    UtTest_Add(CS_UpdateCDS_Test_CopyToCDSFail, CS_Test_Setup, CS_Test_TearDown,
               "CS_UpdateCDS_Test_CopyToCDSFail");
    UtTest_Add(CS_UpdateCDS_Test_NullCDSHandle, CS_Test_Setup, CS_Test_TearDown,
               "CS_UpdateCDS_Test_NullCDSHandle");
#endif /* #if (CS_PRESERVE_STATES_ON_PROCESSOR_RESET == TRUE) */
