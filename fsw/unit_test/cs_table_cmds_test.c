...
void CS_DisableTablesCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_TABLES_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableTablesCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_TABLES_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineTablesCmd_Test_Computed(void) {
    ...
    CS_AppData.ResTablesTblPtr[0].State =
        99; /* Needed to make CS_GetTableResTblEntryByName return correct
               results */
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_BASELINE_TABLES_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineTablesCmd_Test_NotYetComputed(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_NO_BASELINE_TABLES_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineTablesCmd_Test_TableNotFound(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_BASELINE_INVALID_NAME_TABLES_ERR_EID, CFE_EVS_ERROR,
...
void CS_RecomputeBaselineTablesCmd_Test_Nominal(void) {
    ...
    UtAssert_True(CS_AppData.ChildTaskTable == CS_TABLES_TABLE,
                  "CS_AppData.ChildTaskTable == CS_TABLES_TABLE");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_TABLES_STARTED_DBG_EID, CFE_EVS_DEBUG,
...
void CS_RecomputeBaselineTablesCmd_Test_CreateChildTaskError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_TABLES_CREATE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                      "Recompute baseline of table name failed, "
...
void CS_RecomputeBaselineTablesCmd_Test_TableNotFound(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_UNKNOWN_NAME_TABLES_ERR_EID, CFE_EVS_ERROR,
...
void CS_RecomputeBaselineTablesCmd_Test_RecomputeInProgress(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_TABLES_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                             "Tables recompute baseline for table name failed: "
                             "child task in use"),
...
void CS_DisableNameTablesCmd_Test_Nominal(void) {
    ...
    CS_AppData.DefTablesTblPtr[0].State =
        99; /* Needed to make CS_GetTableDefTblEntryByName return correct
               results */
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].State == CS_STATE_DISABLED,
                  "CS_AppData.ResTablesTblPtr[0].State == CS_STATE_DISABLED");
    ...
    UtAssert_True(CS_AppData.DefTablesTblPtr[0].State == CS_STATE_DISABLED,
...
void CS_DisableNameTablesCmd_Test_TableDefNotFound(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_DISABLE_TABLE_DEF_NOT_FOUND_DBG_EID, CFE_EVS_DEBUG,
...
void CS_DisableNameTablesCmd_Test_TableNotFound(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_DISABLE_TABLES_UNKNOWN_NAME_ERR_EID, CFE_EVS_ERROR,
...
void CS_EnableNameTablesCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.ResTablesTblPtr[0].State == CS_STATE_ENABLED,
                  "CS_AppData.ResTablesTblPtr[0].State == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.DefTablesTblPtr[0].State == CS_STATE_ENABLED,
                  "CS_AppData.DefTablesTblPtr[0].State == CS_STATE_ENABLED");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_TABLES_NAME_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableNameTablesCmd_Test_TableNotFound(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_ENABLE_TABLES_UNKNOWN_NAME_ERR_EID, CFE_EVS_ERROR,
...
void CS_Table_Cmds_Test_AddTestCases(void) {
    UtTest_Add(CS_DisableTablesCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_DisableTablesCmd_Test");

    UtTest_Add(CS_EnableTablesCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_EnableTablesCmd_Test");

    UtTest_Add(CS_ReportBaselineTablesCmd_Test_Computed, CS_Test_Setup,
               CS_Test_TearDown, "CS_ReportBaselineTablesCmd_Test_Computed");
    UtTest_Add(CS_ReportBaselineTablesCmd_Test_NotYetComputed, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ReportBaselineTablesCmd_Test_NotYetComputed");
    UtTest_Add(CS_ReportBaselineTablesCmd_Test_TableNotFound, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ReportBaselineTablesCmd_Test_TableNotFound");

    UtTest_Add(CS_RecomputeBaselineTablesCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeBaselineTablesCmd_Test_Nominal");
    UtTest_Add(CS_RecomputeBaselineTablesCmd_Test_CreateChildTaskError,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_RecomputeBaselineTablesCmd_Test_CreateChildTaskError");
    UtTest_Add(CS_RecomputeBaselineTablesCmd_Test_TableNotFound, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeBaselineTablesCmd_Test_TableNotFound");
    UtTest_Add(CS_RecomputeBaselineTablesCmd_Test_RecomputeInProgress,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_RecomputeBaselineTablesCmd_Test_RecomputeInProgress");

    UtTest_Add(CS_DisableNameTablesCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_DisableNameTablesCmd_Test_Nominal");
    UtTest_Add(CS_DisableNameTablesCmd_Test_TableDefNotFound, CS_Test_Setup,
               CS_Test_TearDown,
    ...
    UtTest_Add(CS_EnableNameTablesCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_EnableNameTablesCmd_Test_Nominal");
    UtTest_Add(CS_EnableNameTablesCmd_Test_TableDefNotFound, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_EnableNameTablesCmd_Test_TableDefNotFound");
    UtTest_Add(CS_EnableNameTablesCmd_Test_TableNotFound, CS_Test_Setup,
               CS_Test_TearDown, "CS_EnableNameTablesCmd_Test_TableNotFound");
