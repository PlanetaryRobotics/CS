...
void CS_DisableMemoryCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_MEMORY_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableMemoryCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_MEMORY_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_Computed(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_BASELINE_MEMORY_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_NotYetComputed(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            CS_NO_BASELINE_MEMORY_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_BASELINE_INVALID_ENTRY_MEMORY_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Memory report baseline failed, Entry "
                                       "ID invalid: 16, State: 3 Max ID: 15"),
                  "Memory report baseline failed, Entry ID invalid: 16, State: "
                  "3 Max ID: 15");
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_InvalidEntryErrorStateEmpty(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_BASELINE_INVALID_ENTRY_MEMORY_ERR_EID,
                  ...
                  "Memory report baseline failed, Entry ID invalid: 1, State: "
                  "0 Max ID: 15");
...
void CS_RecomputeBaselineMemoryCmd_Test_Nominal(void) {
    ...
    UtAssert_True(CS_AppData.ChildTaskTable == CS_MEMORY_TABLE,
    ...
    UtAssert_True(CS_AppData.RecomputeEepromMemoryEntryPtr ==
                      &CS_AppData.ResMemoryTblPtr[CmdPacket.EntryID],
                  "CS_AppData.RecomputeEepromMemoryEntryPtr == "
                  "&CS_AppData.ResMemoryTblPtr[CmdPacket.EntryID]");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_MEMORY_STARTED_DBG_EID, CFE_EVS_DEBUG,
...
void CS_RecomputeBaselineMemoryCmd_Test_CreateChildTaskError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_MEMORY_CREATE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                      "Recompute baseline of Memory Entry ID 1 failed, "
                      "ES_CreateChildTask returned:  0xFFFFFFFF"),
                  "Recompute baseline of Memory Entry ID 1 failed, "
                  "ES_CreateChildTask returned:  0xFFFFFFFF");
...
void CS_RecomputeBaselineMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_INVALID_ENTRY_MEMORY_ERR_EID, CFE_EVS_ERROR,
                      "Memory recompute baseline of entry failed, Entry ID "
...
void CS_RecomputeBaselineMemoryCmd_Test_RecomputeInProgress(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_MEMORY_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                             "Recompute baseline of Memory Entry ID 1 failed: "
                             "child task in use"),
...
void CS_EnableEntryIDMemoryCmd_Test_Nominal(void) {
    ...
    UtAssert_True(
        ...
        "CS_AppData.ResMemoryTblPtr[CmdPacket.EntryID].State == "
        "CS_STATE_ENABLED");

    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_ENABLE_MEMORY_ENTRY_INF_EID, CFE_EVS_INFORMATION,
                      "Checksumming of Memory Entry ID 1 is Enabled"),
                  "Checksumming of Memory Entry ID 1 is Enabled");

    UtAssert_True(
        CS_AppData.DefMemoryTblPtr[CmdPacket.EntryID].State == CS_STATE_ENABLED,
        "CS_AppData.DefMemoryTblPtr[CmdPacket.EntryID].State == "
        "CS_STATE_ENABLED");
...
void CS_EnableEntryIDMemoryCmd_Test_DefMemoryTblPtrStateEmpty(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_MEMORY_DEF_EMPTY_DBG_EID, CFE_EVS_DEBUG,
                             "CS unable to update memory definition table for "
                             "entry 1, State: 0"),
...
void CS_EnableEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_ENABLE_MEMORY_INVALID_ENTRY_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Enable Memory entry failed, invalid "
                                       "Entry ID:  16, State: 3, Max ID: 15"),
                  "Enable Memory entry failed, invalid Entry ID:  16, State: "
                  "3, Max ID: 15");
...
void CS_EnableEntryIDMemoryCmd_Test_InvalidEntryErrorStateEmpty(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_ENABLE_MEMORY_INVALID_ENTRY_ERR_EID,
                  ...
                  "Enable Memory entry failed, invalid Entry ID:  1, State: 0, "
                  "Max ID: 15");
...
void CS_DisableEntryIDMemoryCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.ResMemoryTblPtr[CmdPacket.EntryID].State ==
                      CS_STATE_DISABLED,
                  "CS_AppData.ResMemoryTblPtr[CmdPacket.EntryID].State == "
                  "CS_STATE_DISABLED");
    UtAssert_True(
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_DISABLE_MEMORY_ENTRY_INF_EID, CFE_EVS_INFORMATION,
                      "Checksumming of Memory Entry ID 1 is Disabled"),
                  "Checksumming of Memory Entry ID 1 is Disabled");

    UtAssert_True(CS_AppData.DefMemoryTblPtr[CmdPacket.EntryID].State ==
                      CS_STATE_DISABLED,
                  "CS_AppData.DefMemoryTblPtr[CmdPacket.EntryID].State == "
                  "CS_STATE_DISABLED");
...
void CS_DisableEntryIDMemoryCmd_Test_DefMemoryTblPtrStateEmpty(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_MEMORY_DEF_EMPTY_DBG_EID, CFE_EVS_DEBUG,
                             "CS unable to update memory definition table for "
                             "entry 1, State: 0"),
        "CS unable to update memory definition table for entry 1, State: 0");
...
void CS_DisableEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_DISABLE_MEMORY_INVALID_ENTRY_ERR_EID,
                                       CFE_EVS_ERROR,
                                       "Disable Memory entry failed, invalid "
                                       "Entry ID:  16, State: 3, Max ID: 15"),
                  "Disable Memory entry failed, invalid Entry ID:  16, State: "
                  "3, Max ID: 15");
...
void CS_DisableEntryIDMemoryCmd_Test_InvalidEntryErrorStateEmpty(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(CS_DISABLE_MEMORY_INVALID_ENTRY_ERR_EID,
                                       ...
                                       "Disable Memory entry failed, invalid "
                                       "Entry ID:  1, State: 0, Max ID: 15"),
                  "Disable Memory entry failed, invalid Entry ID:  1, State: "
                  "0, Max ID: 15");
...
void CS_Memory_Cmds_Test_AddTestCases(void) {
    UtTest_Add(CS_DisableMemoryCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_DisableMemoryCmd_Test");

    UtTest_Add(CS_EnableMemoryCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_EnableMemoryCmd_Test");

    UtTest_Add(CS_ReportBaselineEntryIDMemoryCmd_Test_Computed, CS_Test_Setup,
               CS_Test_TearDown,
    ...
    UtTest_Add(
        ...
        CS_Test_Setup, CS_Test_TearDown,
        "CS_ReportBaselineEntryIDMemoryCmd_Test_"
    ...
    UtTest_Add(CS_RecomputeBaselineMemoryCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeBaselineMemoryCmd_Test_Nominal");
    ...
    UtTest_Add(CS_EnableEntryIDMemoryCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_EnableEntryIDMemoryCmd_Test_Nominal");
    ...
    UtTest_Add(CS_DisableEntryIDMemoryCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_DisableEntryIDMemoryCmd_Test_Nominal");
    ...
    UtTest_Add(CS_GetEntryIDMemoryCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_GetEntryIDMemoryCmd_Test_Nominal");
    UtTest_Add(CS_GetEntryIDMemoryCmd_Test_AddressNotFound, CS_Test_Setup,
               CS_Test_TearDown, "CS_GetEntryIDMemoryCmd_Test_AddressNotFound");
