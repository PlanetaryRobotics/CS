...
int32 CS_CMDS_TEST_CFE_ES_CreateChildTaskHook(
    uint32 *TaskIdPtr, const char *TaskName,
...
void CS_NoopCmd_Test(void) {
    ...
    /* Verify results */
    sprintf(Message, "No-op command. Version %d.%d.%d.%d", CS_MAJOR_VERSION,
            CS_MINOR_VERSION, CS_REVISION, CS_MISSION_REV);
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_NOOP_INF_EID, CFE_EVS_INFORMATION, Message),
        Message);
...
void CS_ResetCmd_Test(void) {
    ...
    UtAssert_True(CS_AppData.CmdErrCounter == 0,
                  "CS_AppData.CmdErrCounter == 0");
    UtAssert_True(CS_AppData.EepromCSErrCounter == 0,
                  "CS_AppData.EepromCSErrCounter == 0");
    UtAssert_True(CS_AppData.MemoryCSErrCounter == 0,
                  "CS_AppData.MemoryCSErrCounter == 0");
    UtAssert_True(CS_AppData.TablesCSErrCounter == 0,
                  "CS_AppData.TablesCSErrCounter == 0");
    UtAssert_True(CS_AppData.AppCSErrCounter == 0,
                  "CS_AppData.AppCSErrCounter == 0");
    UtAssert_True(CS_AppData.CfeCoreCSErrCounter == 0,
                  "CS_AppData.CfeCoreCSErrCounter == 0");
    UtAssert_True(CS_AppData.OSCSErrCounter == 0,
                  "CS_AppData.OSCSErrCounter == 0");
    UtAssert_True(CS_AppData.PassCounter == 0, "CS_AppData.PassCounter == 0");

    UtAssert_True(Ut_CFE_EVS_EventSent(CS_RESET_DBG_EID, CFE_EVS_DEBUG,
...
void CS_BackgroundCheckCmd_Test_InvalidMsgLength(void) {
    ...
    /* Set size of packet to an invalid value (larger) and prevent InitMsg from
...
void CS_DisableAllCSCmd_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.ChecksumState == CS_STATE_DISABLED,
                  "CS_AppData.ChecksumState == CS_STATE_DISABLED");
    UtAssert_True(CS_AppData.CmdCounter == 1, "CS_AppData.CmdCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_ALL_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableAllCSCmd_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.ChecksumState == CS_STATE_ENABLED,
                  "CS_AppData.ChecksumState == CS_STATE_ENABLED");
    UtAssert_True(CS_AppData.CmdCounter == 1, "CS_AppData.CmdCounter == 1");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_ALL_INF_EID, CFE_EVS_INFORMATION,
...
void CS_DisableCfeCoreCmd_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.CfeCoreCSState == CS_STATE_DISABLED,
                  "CS_AppData.CfeCoreCSState == CS_STATE_DISABLED");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_CFECORE_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableCfeCoreCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_CFECORE_INF_EID, CFE_EVS_INFORMATION,
...
void CS_DisableOSCmd_Test(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.OSCSState == CS_STATE_DISABLED,
                  "CS_AppData.OSCSState == CS_STATE_DISABLED");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_DISABLE_OS_INF_EID, CFE_EVS_INFORMATION,
...
void CS_EnableOSCmd_Test(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ENABLE_OS_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineCfeCoreCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_BASELINE_CFECORE_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineCfeCoreCmd_Test_NotComputedYet(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_NO_BASELINE_CFECORE_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineOSCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_BASELINE_OS_INF_EID, CFE_EVS_INFORMATION,
...
void CS_ReportBaselineOSCmd_Test_NotComputedYet(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_NO_BASELINE_OS_INF_EID, CFE_EVS_INFORMATION,
...
void CS_RecomputeBaselineCfeCoreCmd_Test_Nominal(void) {
    ...
    /* Verify results */
    UtAssert_True(CS_AppData.RecomputeInProgress == TRUE,
                  "CS_AppData.RecomputeInProgress == TRUE");
    UtAssert_True(CS_AppData.OneShotInProgress == FALSE,
                  "CS_AppData.OneShotInProgress == FALSE");
    UtAssert_True(CS_AppData.ChildTaskTable == CS_CFECORE,
                  "CS_AppData.ChildTaskTable == CS_CFECORE");
    UtAssert_True(CS_AppData.ChildTaskEntryID == 0,
                  "CS_AppData.ChildTaskEntryID == 0");
    UtAssert_True(
        CS_AppData.RecomputeEepromMemoryEntryPtr == &CS_AppData.CfeCoreCodeSeg,
        "CS_AppData.RecomputeEepromMemoryEntryPtr == "
        "&CS_AppData.CfeCoreCodeSeg");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_CFECORE_STARTED_DBG_EID,
                             CFE_EVS_DEBUG, "Recompute of cFE core started"),
...
void CS_RecomputeBaselineCfeCoreCmd_Test_CreateChildTaskError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_CFECORE_CREATE_CHDTASK_ERR_EID,
                             CFE_EVS_ERROR,
                             "Recompute cFE core failed, "
                             "CFE_ES_CreateChildTask returned: 0xFFFFFFFF"),
        "Recompute cFE core failed, CFE_ES_CreateChildTask returned: "
        "0xFFFFFFFF");
...
void CS_RecomputeBaselineCfeCoreCmd_Test_ChildTaskError(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_CFECORE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
...
void CS_RecomputeBaselineOSCmd_Test_Nominal(void) {
    ...
    UtAssert_True(CS_AppData.OneShotInProgress == FALSE,
                  "CS_AppData.OneShotInProgress == FALSE");
    UtAssert_True(CS_AppData.ChildTaskTable == CS_OSCORE,
                  "CS_AppData.ChildTaskTable == CS_OSCORE");
    UtAssert_True(CS_AppData.ChildTaskEntryID == 0,
                  "CS_AppData.OSCodeSeg == 0");
    UtAssert_True(
        CS_AppData.RecomputeEepromMemoryEntryPtr == &CS_AppData.OSCodeSeg,
        "CS_AppData.RecomputeEepromMemoryEntryPtr == &CS_AppData.OSCodeSeg");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_RECOMPUTE_OS_STARTED_DBG_EID, CFE_EVS_DEBUG,
...
void CS_RecomputeBaselineOSCmd_Test_CreateChildTaskError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_OS_CREATE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                      "Recompute OS code segment failed, "
                      "CFE_ES_CreateChildTask returned: 0xFFFFFFFF"),
                  "Recompute OS code segment failed, CFE_ES_CreateChildTask "
                  "returned: 0xFFFFFFFF");
...
void CS_RecomputeBaselineOSCmd_Test_ChildTaskError(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_RECOMPUTE_OS_CHDTASK_ERR_EID, CFE_EVS_ERROR,
...
void CS_OneShotCmd_Test_Nominal(void) {
    ...
    Ut_CFE_ES_SetFunctionHook(UT_CFE_ES_CREATECHILDTASK_INDEX,
                              &CS_CMDS_TEST_CFE_ES_CreateChildTaskHook);
    ...
    UtAssert_True(CS_AppData.RecomputeInProgress == FALSE,
                  "CS_AppData.RecomputeInProgress == FALSE");
    UtAssert_True(CS_AppData.OneShotInProgress == TRUE,
                  "CS_AppData.OneShotInProgress == TRUE");

    UtAssert_True(CS_AppData.LastOneShotAddress == CmdPacket.Address,
                  "CS_AppData.LastOneShotAddress == CmdPacket.Address");
    UtAssert_True(CS_AppData.LastOneShotSize == CmdPacket.Size,
                  "CS_AppData.LastOneShotSize == CmdPacket.Size");
    UtAssert_True(CS_AppData.LastOneShotChecksum == 0,
...
void CS_OneShotCmd_Test_MaxBytesPerCycleNonZero(void) {
    ...
    UtAssert_True(CS_AppData.LastOneShotChecksum == 0,
                  "CS_AppData.LastOneShotChecksum == 0");
    UtAssert_True(
        CS_AppData.LastOneShotMaxBytesPerCycle == CmdPacket.MaxBytesPerCycle,
        "CS_AppData.LastOneShotMaxBytesPerCycle == CmdPacket.MaxBytesPerCycle");
...
void CS_OneShotCmd_Test_CreateChildTaskError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ONESHOT_CREATE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
                             "OneShot checkum failed, CFE_ES_CreateChildTask "
                             "returned: 0xFFFFFFFF"),
...
void CS_OneShotCmd_Test_ChildTaskError(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ONESHOT_CHDTASK_ERR_EID, CFE_EVS_ERROR,
...
void CS_OneShotCmd_Test_MemValidateRangeError(void) {
    ...
    /* Verify results */
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ONESHOT_MEMVALIDATE_ERR_EID, CFE_EVS_ERROR,
                             "OneShot checksum failed, "
                             "CFE_PSP_MemValidateRange returned: 0xFFFFFFFF"),
        "OneShot checksum failed, CFE_PSP_MemValidateRange returned: "
        "0xFFFFFFFF");
...
void CS_CancelOneShotCmd_Test_Nominal(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(CS_ONESHOT_CANCELLED_INF_EID, CFE_EVS_INFORMATION,
...
void CS_CancelOneShotCmd_Test_DeleteChildTaskError(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_ONESHOT_CANCEL_DELETE_CHDTASK_ERR_EID, CFE_EVS_ERROR,
...
void CS_CancelOneShotCmd_Test_NoChildTaskError(void) {
    ...
    /* Verify results */
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      CS_ONESHOT_CANCEL_NO_CHDTASK_ERR_EID, CFE_EVS_ERROR,
...
void CS_Cmds_Test_AddTestCases(void) {
    UtTest_Add(CS_NoopCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_NoopCmd_Test");

    UtTest_Add(CS_ResetCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_ResetCmd_Test");

    UtTest_Add(CS_BackgroundCheckCmd_Test_InvalidMsgLength, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_InvalidMsgLength");
    UtTest_Add(CS_BackgroundCheckCmd_Test_BackgroundCfeCore, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_BackgroundCheckCmd_Test_BackgroundCfeCore");
    UtTest_Add(CS_BackgroundCheckCmd_Test_BackgroundOS, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_BackgroundOS");
    UtTest_Add(CS_BackgroundCheckCmd_Test_BackgroundEeprom, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_BackgroundEeprom");
    UtTest_Add(CS_BackgroundCheckCmd_Test_BackgroundMemory, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_BackgroundMemory");
    UtTest_Add(CS_BackgroundCheckCmd_Test_BackgroundTables, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_BackgroundTables");
    UtTest_Add(CS_BackgroundCheckCmd_Test_BackgroundApp, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_BackgroundApp");
    UtTest_Add(CS_BackgroundCheckCmd_Test_Default, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_Default");
    UtTest_Add(CS_BackgroundCheckCmd_Test_Disabled, CS_Test_Setup,
               CS_Test_TearDown, "CS_BackgroundCheckCmd_Test_Disabled");

    UtTest_Add(CS_DisableAllCSCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_DisableAllCSCmd_Test");

    UtTest_Add(CS_EnableAllCSCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_EnableAllCSCmd_Test");

    UtTest_Add(CS_DisableCfeCoreCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_DisableCfeCoreCmd_Test");

    UtTest_Add(CS_EnableCfeCoreCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_EnableCfeCoreCmd_Test");

    UtTest_Add(CS_DisableOSCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_DisableOSCmd_Test");

    UtTest_Add(CS_EnableOSCmd_Test, CS_Test_Setup, CS_Test_TearDown,
               "CS_EnableOSCmd_Test");

    UtTest_Add(CS_ReportBaselineCfeCoreCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_ReportBaselineCfeCoreCmd_Test_Nominal");
    UtTest_Add(CS_ReportBaselineCfeCoreCmd_Test_NotComputedYet, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_ReportBaselineCfeCoreCmd_Test_NotComputedYet");

    UtTest_Add(CS_ReportBaselineOSCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_ReportBaselineOSCmd_Test_Nominal");
    UtTest_Add(CS_ReportBaselineOSCmd_Test_NotComputedYet, CS_Test_Setup,
               CS_Test_TearDown, "CS_ReportBaselineOSCmd_Test_NotComputedYet");

    UtTest_Add(CS_RecomputeBaselineCfeCoreCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeBaselineCfeCoreCmd_Test_Nominal");
    ...
    UtTest_Add(CS_RecomputeBaselineOSCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_RecomputeBaselineOSCmd_Test_Nominal");
    UtTest_Add(CS_RecomputeBaselineOSCmd_Test_CreateChildTaskError,
               CS_Test_Setup, CS_Test_TearDown,
               "CS_RecomputeBaselineOSCmd_Test_CreateChildTaskError");
    UtTest_Add(CS_RecomputeBaselineOSCmd_Test_ChildTaskError, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_RecomputeBaselineOSCmd_Test_ChildTaskError");

    UtTest_Add(CS_OneShotCmd_Test_Nominal, CS_Test_Setup, CS_Test_TearDown,
               "CS_OneShotCmd_Test_Nominal");
    UtTest_Add(CS_OneShotCmd_Test_MaxBytesPerCycleNonZero, CS_Test_Setup,
               CS_Test_TearDown, "CS_OneShotCmd_Test_MaxBytesPerCycleNonZero");
    UtTest_Add(CS_OneShotCmd_Test_CreateChildTaskError, CS_Test_Setup,
               CS_Test_TearDown, "CS_OneShotCmd_Test_CreateChildTaskError");
    UtTest_Add(CS_OneShotCmd_Test_ChildTaskError, CS_Test_Setup,
               CS_Test_TearDown, "CS_OneShotCmd_Test_ChildTaskError");
    UtTest_Add(CS_OneShotCmd_Test_MemValidateRangeError, CS_Test_Setup,
               CS_Test_TearDown, "CS_OneShotCmd_Test_MemValidateRangeError");

    UtTest_Add(CS_CancelOneShotCmd_Test_Nominal, CS_Test_Setup,
               CS_Test_TearDown, "CS_CancelOneShotCmd_Test_Nominal");
    UtTest_Add(CS_CancelOneShotCmd_Test_DeleteChildTaskError, CS_Test_Setup,
               CS_Test_TearDown,
               "CS_CancelOneShotCmd_Test_DeleteChildTaskError");
    UtTest_Add(CS_CancelOneShotCmd_Test_NoChildTaskError, CS_Test_Setup,
               CS_Test_TearDown, "CS_CancelOneShotCmd_Test_NoChildTaskError");
