 ...
 **
 **  \par Limits:
 **       This parameter is limited by the maximum number of applications
 *allowed
 ...
 **
 **  \par Limits:
 **       This parameter is limited by the maximum value allowed by the data
 *type.
 **       In this case, the data type is an unsigned 32-bit integer, so the
 *valid
 ...
 **
 **  \par  Description:
 **        Priority of child tasks created by CS.  Lower numbers are higher
 *priority,
