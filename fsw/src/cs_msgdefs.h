 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_ONESHOT_CANCELLED_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       - The #CS_NO_BASELINE_CFECORE_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_RECOMPUTE_CFECORE_STARTED_DBG_EID debug event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **         generated when the command is received, or
 **       - The #CS_NO_BASELINE_EEPROM_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_ENABLE_EEPROM_ENTRY_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_DISABLE_EEPROM_ENTRY_INF_EID informational event message
 *will be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_GET_ENTRY_ID_EEPROM_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **         generated when the command is received, or
 **       - The #CS_NO_BASELINE_MEMORY_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_ENABLE_MEMORY_ENTRY_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_DISABLE_MEMORY_ENTRY_INF_EID informational event message
 *will be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_GET_ENTRY_ID_MEMORY_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **         generated when the command is received, or
 **       - The #CS_NO_BASELINE_TABLES_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_ENABLE_TABLES_NAME_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
 ...
 **       the following telemetry:
 **       - \b \c \CS_CMDPC - command counter will increment
 **       - The #CS_DISABLE_TABLES_NAME_INF_EID informational event message will
 *be
 **         generated when the command is received
 **
 **  \par Error Conditions
...
/** \brief States used in the Table as well as for the state of the entire
 * Checksumming feature */
/** \{ */
#define CS_STATE_EMPTY 0x00 /**< \brief The entry is not valid */
#define CS_STATE_ENABLED                           \
    0x01 /**< \brief Either the entry in the table \
                     is enabled to be checksummed  \
                     or the table is enabled */
#define CS_STATE_DISABLED                          \
    0x02 /**< \brief Either the entry in the table \
                     is disabled for checksumming  \
                     or the table is disabled */
#define CS_STATE_UNDEFINED                         \
    0x03 /**< \brief The entry is not in the table \
