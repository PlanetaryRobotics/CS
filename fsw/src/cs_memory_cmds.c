    ...
    if (CS_VerifyCmdLength(MessagePtr, ExpectedLength)) {
        ...
        if ((EntryID < CS_MAX_NUM_MEMORY_TABLE_ENTRIES) &&
            ...
            CFE_EVS_SendEvent(CS_BASELINE_INVALID_ENTRY_MEMORY_ERR_EID,
                              ...
                              "Memory report baseline failed, Entry ID "
        ...
        if (CS_AppData.RecomputeInProgress == false &&
            ...
            if ((EntryID < CS_MAX_NUM_MEMORY_TABLE_ENTRIES) &&
                ...
                CS_AppData.RecomputeEepromMemoryEntryPtr =
                    &CS_AppData.ResMemoryTblPtr[EntryID];

                Status = CFE_ES_CreateChildTask(
                    &ChildTaskID, CS_RECOMP_MEMORY_TASK_NAME,
                ...
                } else /* child task creation failed */
                {
                    CFE_EVS_SendEvent(
                        ...
                        CFE_EVS_EventType_ERROR,
                        "Recompute baseline of Memory Entry ID %d failed, "
                        "ES_CreateChildTask returned:  0x%08X",
                ...
                CFE_EVS_SendEvent(CS_RECOMPUTE_INVALID_ENTRY_MEMORY_ERR_EID,
                                  CFE_EVS_EventType_ERROR,
                                  "Memory recompute baseline of entry failed, "
            ...
            CFE_EVS_SendEvent(CS_RECOMPUTE_MEMORY_CHDTASK_ERR_EID,
                              CFE_EVS_EventType_ERROR,
                              "Recompute baseline of Memory Entry ID %d "
...
void CS_EnableEntryIDMemoryCmd(CFE_SB_MsgPtr_t MessagePtr) {
    ...
    if (CS_VerifyCmdLength(MessagePtr, ExpectedLength)) {
        ...
        if ((EntryID < CS_MAX_NUM_MEMORY_TABLE_ENTRIES) &&
            ...
            CFE_EVS_SendEvent(
                CS_ENABLE_MEMORY_ENTRY_INF_EID, CFE_EVS_EventType_INFORMATION,
            ...
            if (CS_AppData.DefMemoryTblPtr[EntryID].State != CS_STATE_EMPTY) {
                ...
                CFE_EVS_SendEvent(CS_ENABLE_MEMORY_DEF_EMPTY_DBG_EID,
                                  CFE_EVS_EventType_DEBUG,
                                  "CS unable to update memory definition table "
                                  "for entry %d, State: %d",
                                  EntryID, State);
            }
            ...
            CFE_EVS_SendEvent(
                CS_ENABLE_MEMORY_INVALID_ENTRY_ERR_EID, CFE_EVS_EventType_ERROR,
                "Enable Memory entry failed, invalid Entry ID:  %d, State: %d, "
                "Max ID: %d",
...
void CS_DisableEntryIDMemoryCmd(CFE_SB_MsgPtr_t MessagePtr) {
    ...
    if (CS_VerifyCmdLength(MessagePtr, ExpectedLength)) {
        ...
        if ((EntryID < CS_MAX_NUM_MEMORY_TABLE_ENTRIES) &&
            ...
            CFE_EVS_SendEvent(
                CS_DISABLE_MEMORY_ENTRY_INF_EID, CFE_EVS_EventType_INFORMATION,
            ...
            CFE_EVS_SendEvent(CS_DISABLE_MEMORY_INVALID_ENTRY_ERR_EID,
                              CFE_EVS_EventType_ERROR,
                              "Disable Memory entry failed, invalid Entry ID:  "
                              "%d, State: %d, Max ID: %d",
                              EntryID, State,
                              (CS_MAX_NUM_MEMORY_TABLE_ENTRIES - 1));
