...
typedef struct {
    ...
    uint32 ByteOffset; /**< \brief Where a previous unfinished calculation left
                          off */
...
typedef struct {
    ...
    uint32 TempChecksumValue; /**< \brief The unfinished caluculation */
    CFE_TBL_Handle_t
        TblHandle;  /**< \brief handle recieved from table services */
 ...
 **
 **  \returns
 **  \retstmt Returns Results from #CFE_TBL_GetAddress or #CFE_TBL_Manage
 *\endcode
 **  \endreturns
 *************************************************************************/
