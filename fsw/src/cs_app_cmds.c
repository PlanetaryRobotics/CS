...
void CS_DisableAppCmd(CFE_SB_MsgPtr_t MessagePtr) {
    ...
    if (CS_VerifyCmdLength(MessagePtr, ExpectedLength)) {
        ...
        CFE_EVS_SendEvent(CS_DISABLE_APP_INF_EID, CFE_EVS_EventType_INFORMATION,
...
void CS_EnableAppCmd(CFE_SB_MsgPtr_t MessagePtr) {
    ...
    if (CS_VerifyCmdLength(MessagePtr, ExpectedLength)) {
        ...
        CFE_EVS_SendEvent(CS_ENABLE_APP_INF_EID, CFE_EVS_EventType_INFORMATION,
        ...
        if (CS_GetAppResTblEntryByName(&ResultsEntry, CmdPtr->Name)) {
            if (ResultsEntry->ComputedYet == true) {
                ...
                CFE_EVS_SendEvent(CS_BASELINE_APP_INF_EID,
                                  ...
                                  CmdPtr->Name, (unsigned int)Baseline);
            } else {
                CFE_EVS_SendEvent(
                    CS_NO_BASELINE_APP_INF_EID, CFE_EVS_EventType_INFORMATION,
            ...
            CFE_EVS_SendEvent(
                CS_BASELINE_INVALID_NAME_APP_ERR_EID, CFE_EVS_EventType_ERROR,
                "App report baseline failed, app %s not found", CmdPtr->Name);
        ...
        if (CS_AppData.RecomputeInProgress == false &&
            ...
            if (CS_GetAppResTblEntryByName(&ResultsEntry, CmdPtr->Name)) {
                ...
                Status = CFE_ES_CreateChildTask(
                    &ChildTaskID, CS_RECOMP_APP_TASK_NAME,
                    CS_RecomputeAppChildTask, NULL,
                ...
                } else /* child task creation failed */
                {
                    CFE_EVS_SendEvent(CS_RECOMPUTE_APP_CREATE_CHDTASK_ERR_EID,
                                      ...
                                      "Recompute baseline of app %s failed, "
                                      "CFE_ES_CreateChildTask returned: 0x%08X",
                                      CmdPtr->Name, (unsigned int)Status);
                    CS_AppData.CmdErrCounter++;
            ...
            CFE_EVS_SendEvent(
                CS_RECOMPUTE_APP_CHDTASK_ERR_EID, CFE_EVS_EventType_ERROR,
...
void CS_DisableNameAppCmd(CFE_SB_MsgPtr_t MessagePtr) {
    ...
    if (CS_VerifyCmdLength(MessagePtr, ExpectedLength)) {
        ...
        if (CS_GetAppResTblEntryByName(&ResultsEntry, CmdPtr->Name)) {
            ...
            CFE_EVS_SendEvent(
                CS_DISABLE_APP_NAME_INF_EID, CFE_EVS_EventType_INFORMATION,
                "Checksumming of app %s is Disabled", CmdPtr->Name);
            ...
            CFE_EVS_SendEvent(
                CS_DISABLE_APP_UNKNOWN_NAME_ERR_EID, CFE_EVS_EventType_ERROR,
...
void CS_EnableNameAppCmd(CFE_SB_MsgPtr_t MessagePtr) {
    ...
    if (CS_VerifyCmdLength(MessagePtr, ExpectedLength)) {
        ...
        if (CS_GetAppResTblEntryByName(&ResultsEntry, CmdPtr->Name)) {
            ...
            CFE_EVS_SendEvent(
                CS_ENABLE_APP_NAME_INF_EID, CFE_EVS_EventType_INFORMATION,
                "Checksumming of app %s is Enabled", CmdPtr->Name);
